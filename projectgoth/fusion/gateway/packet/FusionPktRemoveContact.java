...
public class FusionPktRemoveContact extends FusionPktDataRemoveContact {
   private static final Logger log = Logger.getLogger(ConfigUtils.getLoggerName(FusionPktRemoveContact.class));
