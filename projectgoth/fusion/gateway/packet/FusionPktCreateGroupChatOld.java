...
public class FusionPktCreateGroupChatOld extends FusionRequest {
   private static final Logger log = Logger.getLogger(ConfigUtils.getLoggerName(FusionPktCreateGroupChatOld.class));
   ...
   protected FusionPacket[] processRequest(ConnectionI connection) {
      try {
         ...
         return (new FusionPktError(this.transactionId, FusionPktError.Code.UNDEFINED, "Failed to create group chat - " + var6.message)).toArray();
      } catch (LocalException var7) {
         return (new FusionPktInternalServerError(this.transactionId, var7, "Failed to create group chat")).toArray();
      } catch (Exception var8) {
         return (new FusionPktError(this.transactionId, FusionPktError.Code.UNDEFINED, "Failed to create group chat - " + var8.getMessage())).toArray();
      }
   }
}
