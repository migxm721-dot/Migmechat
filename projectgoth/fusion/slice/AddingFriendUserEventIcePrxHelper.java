...
public final class AddingFriendUserEventIcePrxHelper extends ObjectPrxHelperBase implements AddingFriendUserEventIcePrx {
   public static AddingFriendUserEventIcePrx checkedCast(ObjectPrx __obj) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::AddingFriendUserEventIce")) {
      ...
      return (AddingFriendUserEventIcePrx)__d;
   }
   ...
   public static AddingFriendUserEventIcePrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::AddingFriendUserEventIce", __ctx)) {
               AddingFriendUserEventIcePrxHelper __h = new AddingFriendUserEventIcePrxHelper();
               __h.__copyFrom(__obj);
               __d = __h;
            }
