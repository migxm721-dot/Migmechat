...
public class UserNotificationServiceStats extends BaseServiceStats {
   ...
   public void __write(BasicStream __os) {
      ...
      __os.writeLong(this.alertsSent);
      __os.writeLong(this.emailsSent);
      __os.writeLong(this.smsSent);
      __os.writeLong(this.notificationsSent);
      __os.writeInt(this.alertQueueSize);
      __os.writeInt(this.emailQueueSize);
      __os.writeInt(this.smsQueueSize);
      __os.writeInt(this.notificationQueueSize);
      __os.endWriteSlice();
      super.__write(__os);
   }
   ...
   public void __read(BasicStream __is, boolean __rid) {
      ...
      __is.startReadSlice();
      this.alertsSent = __is.readLong();
      this.emailsSent = __is.readLong();
      this.smsSent = __is.readLong();
      this.notificationsSent = __is.readLong();
      this.alertQueueSize = __is.readInt();
      this.emailQueueSize = __is.readInt();
      this.smsQueueSize = __is.readInt();
      this.notificationQueueSize = __is.readInt();
      __is.endReadSlice();
   ...
   public void __write(OutputStream __outS) {
      ...
      ex.reason = "type com::projectgoth::fusion::slice::UserNotificationServiceStats was not generated with stream support";
      throw ex;
   }
   ...
   private static class __F implements ObjectFactory {
      ...
      public Object create(String type) {
         assert type.equals(UserNotificationServiceStats.ice_staticId());

         return new UserNotificationServiceStats();
      }
