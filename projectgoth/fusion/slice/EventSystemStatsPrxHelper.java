...
public final class EventSystemStatsPrxHelper extends ObjectPrxHelperBase implements EventSystemStatsPrx {
   public static EventSystemStatsPrx checkedCast(ObjectPrx __obj) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::EventSystemStats")) {
      ...
      return (EventSystemStatsPrx)__d;
   }
   ...
   public static EventSystemStatsPrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::EventSystemStats", __ctx)) {
               EventSystemStatsPrxHelper __h = new EventSystemStatsPrxHelper();
               __h.__copyFrom(__obj);
               __d = __h;
            }
