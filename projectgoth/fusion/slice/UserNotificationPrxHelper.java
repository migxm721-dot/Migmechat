...
public final class UserNotificationPrxHelper extends ObjectPrxHelperBase implements UserNotificationPrx {
   public static UserNotificationPrx checkedCast(ObjectPrx __obj) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::UserNotification")) {
      ...
      return (UserNotificationPrx)__d;
   }
   ...
   public static UserNotificationPrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::UserNotification", __ctx)) {
               UserNotificationPrxHelper __h = new UserNotificationPrxHelper();
               __h.__copyFrom(__obj);
               __d = __h;
            }
