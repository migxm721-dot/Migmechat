...
public class SessionCacheStats extends BaseServiceStats {
   ...
   public void __write(BasicStream __os) {
      ...
      __os.writeFloat(this.sessionsReceivedPerSecond);
      __os.writeFloat(this.maxSessionsReceivedPerSecond);
      __os.writeLong(this.dateOfMaxSessionsReceivedPerSecond);
      __os.writeInt(this.sessionsQueuedToBeArchived);
      __os.writeBool(this.uniqueSummariesTaskRunning);
      __os.writeInt(this.abortedBatches);
      __os.endWriteSlice();
      super.__write(__os);
   }
   ...
   public void __read(BasicStream __is, boolean __rid) {
      ...
      __is.startReadSlice();
      this.sessionsReceivedPerSecond = __is.readFloat();
      this.maxSessionsReceivedPerSecond = __is.readFloat();
      this.dateOfMaxSessionsReceivedPerSecond = __is.readLong();
      this.sessionsQueuedToBeArchived = __is.readInt();
      this.uniqueSummariesTaskRunning = __is.readBool();
      this.abortedBatches = __is.readInt();
      __is.endReadSlice();
   ...
   public void __write(OutputStream __outS) {
      ...
      ex.reason = "type com::projectgoth::fusion::slice::SessionCacheStats was not generated with stream support";
      throw ex;
   }
   ...
   private static class __F implements ObjectFactory {
      ...
      public Object create(String type) {
         assert type.equals(SessionCacheStats.ice_staticId());
