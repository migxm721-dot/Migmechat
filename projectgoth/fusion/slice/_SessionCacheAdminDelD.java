...
public final class _SessionCacheAdminDelD extends _ObjectDelD implements _SessionCacheAdminDel {
   public SessionCacheStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionException {
      ...
      final SessionCacheStatsHolder __result = new SessionCacheStatsHolder();
      Direct __direct = null;

      try {
         __direct = new Direct(__current) {
            public DispatchStatus run(Object __obj) {
               SessionCacheAdmin __servant = null;

               try {
                  __servant = (SessionCacheAdmin)__obj;
