...
public class SMSEngineStats extends BaseServiceStats {
   ...
   public void __write(BasicStream __os) {
      ...
      __os.writeInt(this.requestsReceived);
      __os.writeInt(this.requestsDispatched);
      __os.endWriteSlice();
      super.__write(__os);
   }
   ...
   public void __read(BasicStream __is, boolean __rid) {
      ...
      this.requestsReceived = __is.readInt();
      this.requestsDispatched = __is.readInt();
      __is.endReadSlice();
   ...
   public void __write(OutputStream __outS) {
      ...
      ex.reason = "type com::projectgoth::fusion::slice::SMSEngineStats was not generated with stream support";
      throw ex;
   }
   ...
   private static class __F implements ObjectFactory {
      ...
      public Object create(String type) {
         assert type.equals(SMSEngineStats.ice_staticId());

         return new SMSEngineStats();
      }
