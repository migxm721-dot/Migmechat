...
public abstract class _SMSSenderDisp extends ObjectImpl implements SMSSender {
   ...
   public DispatchStatus __dispatch(Incoming in, Current __current) {
      ...
      if (pos < 0) {
         ...
         case 5:
            return ___sendSystemSMS(this, in, __current);
         default:
            assert false;
