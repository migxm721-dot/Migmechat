...
public class ReputationServiceStats extends BaseServiceStats {
   ...
   public void __write(BasicStream __os) {
      ...
      __os.writeLong(this.lastTimeRunCompleted);
      __os.writeBool(this.processing);
      __os.endWriteSlice();
      super.__write(__os);
   }
   ...
   public void __read(BasicStream __is, boolean __rid) {
      ...
      __is.startReadSlice();
      this.lastTimeRunCompleted = __is.readLong();
      this.processing = __is.readBool();
      __is.endReadSlice();
   ...
   public void __write(OutputStream __outS) {
      ...
      ex.reason = "type com::projectgoth::fusion::slice::ReputationServiceStats was not generated with stream support";
      throw ex;
   }
   ...
   private static class __F implements ObjectFactory {
      ...
      public Object create(String type) {
         assert type.equals(ReputationServiceStats.ice_staticId());

         return new ReputationServiceStats();
      }
