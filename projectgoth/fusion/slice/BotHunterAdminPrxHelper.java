...
public final class BotHunterAdminPrxHelper extends ObjectPrxHelperBase implements BotHunterAdminPrx {
   ...
   public static BotHunterAdminPrx checkedCast(ObjectPrx __obj) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::BotHunterAdmin")) {
   ...
   public static BotHunterAdminPrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::BotHunterAdmin", __ctx)) {
               BotHunterAdminPrxHelper __h = new BotHunterAdminPrxHelper();
               __h.__copyFrom(__obj);
               __d = __h;
            }
