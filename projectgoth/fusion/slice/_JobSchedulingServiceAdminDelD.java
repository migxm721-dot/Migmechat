...
public final class _JobSchedulingServiceAdminDelD extends _ObjectDelD implements _JobSchedulingServiceAdminDel {
   public JobSchedulingServiceStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionException {
      ...
      final JobSchedulingServiceStatsHolder __result = new JobSchedulingServiceStatsHolder();
      Direct __direct = null;

      try {
         __direct = new Direct(__current) {
            public DispatchStatus run(Object __obj) {
               JobSchedulingServiceAdmin __servant = null;

               try {
                  __servant = (JobSchedulingServiceAdmin)__obj;
         ...
         JobSchedulingServiceStats var6;
         try {
