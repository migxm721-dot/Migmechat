...
public abstract class _BotHunterDisp extends ObjectImpl implements BotHunter {
   ...
   public final SuspectGroupIce[] getLatestSuspects() throws FusionException {
      return this.getLatestSuspects((Current)null);
   }
   ...
   public DispatchStatus __dispatch(Incoming in, Current __current) {
      ...
      if (pos < 0) {
         ...
         switch(pos) {
         case 0:
            return ___getLatestSuspects(this, in, __current);
         case 1:
