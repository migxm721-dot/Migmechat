...
public final class CredentialPrxHelper extends ObjectPrxHelperBase implements CredentialPrx {
   public static CredentialPrx checkedCast(ObjectPrx __obj) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::Credential")) {
   ...
   public static CredentialPrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::Credential", __ctx)) {
               CredentialPrxHelper __h = new CredentialPrxHelper();
               __h.__copyFrom(__obj);
               __d = __h;
            }
