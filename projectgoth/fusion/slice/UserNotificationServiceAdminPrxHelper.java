...
public final class UserNotificationServiceAdminPrxHelper extends ObjectPrxHelperBase implements UserNotificationServiceAdminPrx {
   ...
   public static UserNotificationServiceAdminPrx checkedCast(ObjectPrx __obj) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::UserNotificationServiceAdmin")) {
      ...
      return (UserNotificationServiceAdminPrx)__d;
   }
   ...
   public static UserNotificationServiceAdminPrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::UserNotificationServiceAdmin", __ctx)) {
               UserNotificationServiceAdminPrxHelper __h = new UserNotificationServiceAdminPrxHelper();
               __h.__copyFrom(__obj);
               __d = __h;
            }
