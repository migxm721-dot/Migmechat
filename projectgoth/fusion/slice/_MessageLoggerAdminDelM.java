...
public final class _MessageLoggerAdminDelM extends _ObjectDelM implements _MessageLoggerAdminDel {
   public MessageLoggerStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionException {
      ...
      try {
         ...
         try {
            ...
            MessageLoggerStatsHolder __ret = new MessageLoggerStatsHolder();
