...
public final class ImageServerStatsPrxHelper extends ObjectPrxHelperBase implements ImageServerStatsPrx {
   public static ImageServerStatsPrx checkedCast(ObjectPrx __obj) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::ImageServerStats")) {
      ...
      return (ImageServerStatsPrx)__d;
   }
   ...
   public static ImageServerStatsPrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::ImageServerStats", __ctx)) {
               ImageServerStatsPrxHelper __h = new ImageServerStatsPrxHelper();
               __h.__copyFrom(__obj);
               __d = __h;
            }
