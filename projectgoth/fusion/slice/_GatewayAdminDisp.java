...
public abstract class _GatewayAdminDisp extends ObjectImpl implements GatewayAdmin {
   ...
   public final void sendAlertToAllConnections(String message, String title) {
      this.sendAlertToAllConnections(message, title, (Current)null);
   }
   ...
   public DispatchStatus __dispatch(Incoming in, Current __current) {
      ...
      if (pos < 0) {
         ...
         case 5:
            return ___sendAlertToAllConnections(this, in, __current);
         default:
            assert false;
