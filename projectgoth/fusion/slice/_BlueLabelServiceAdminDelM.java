...
public final class _BlueLabelServiceAdminDelM extends _ObjectDelM implements _BlueLabelServiceAdminDel {
   public BlueLabelServiceStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionException {
      ...
      try {
         ...
         try {
            ...
            BlueLabelServiceStatsHolder __ret = new BlueLabelServiceStatsHolder();
