...
public final class _RecommendationDataCollectionServiceAdminDelM extends _ObjectDelM implements _RecommendationDataCollectionServiceAdminDel {
   public RecommendationDataCollectionServiceStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionExceptionWithRefCode {
      ...
      try {
         ...
         try {
            ...
            RecommendationDataCollectionServiceStatsHolder __ret = new RecommendationDataCollectionServiceStatsHolder();
