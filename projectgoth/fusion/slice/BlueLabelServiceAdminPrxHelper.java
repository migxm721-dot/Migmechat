...
public final class BlueLabelServiceAdminPrxHelper extends ObjectPrxHelperBase implements BlueLabelServiceAdminPrx {
   ...
   public static BlueLabelServiceAdminPrx checkedCast(ObjectPrx __obj) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::BlueLabelServiceAdmin")) {
      ...
      return (BlueLabelServiceAdminPrx)__d;
   }
   ...
   public static BlueLabelServiceAdminPrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::BlueLabelServiceAdmin", __ctx)) {
               BlueLabelServiceAdminPrxHelper __h = new BlueLabelServiceAdminPrxHelper();
               __h.__copyFrom(__obj);
               __d = __h;
            }
