...
public final class SessionCacheAdminPrxHelper extends ObjectPrxHelperBase implements SessionCacheAdminPrx {
   ...
   public static SessionCacheAdminPrx checkedCast(ObjectPrx __obj) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::SessionCacheAdmin")) {
      ...
      return (SessionCacheAdminPrx)__d;
   }
   ...
   public static SessionCacheAdminPrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::SessionCacheAdmin", __ctx)) {
               SessionCacheAdminPrxHelper __h = new SessionCacheAdminPrxHelper();
               __h.__copyFrom(__obj);
               __d = __h;
            }
