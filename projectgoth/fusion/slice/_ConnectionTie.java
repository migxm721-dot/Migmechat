...
public class _ConnectionTie extends _ConnectionDisp implements TieBase {
   private _ConnectionOperations _ice_delegate;

   public _ConnectionTie() {
   }

   public _ConnectionTie(_ConnectionOperations delegate) {
   ...
   public void ice_delegate(Object delegate) {
      this._ice_delegate = (_ConnectionOperations)delegate;
   }
   ...
   public boolean equals(Object rhs) {
      if (this == rhs) {
         ...
         return !(rhs instanceof _ConnectionTie) ? false : this._ice_delegate.equals(((_ConnectionTie)rhs)._ice_delegate);
      }
   }
