...
public final class ConnectionWSPrxHelper extends ObjectPrxHelperBase implements ConnectionWSPrx {
   ...
   public void addRemoteChildConnectionWS(String uuid, ConnectionWSPrx childConnectionWS) {
      this.addRemoteChildConnectionWS(uuid, childConnectionWS, (Map)null, false);
   }
   ...
   public void removeRemoteChildConnectionWS(String uuid, ConnectionWSPrx childConnectionWS) {
      this.removeRemoteChildConnectionWS(uuid, childConnectionWS, (Map)null, false);
   }
   ...
   public static ConnectionWSPrx checkedCast(ObjectPrx __obj) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::ConnectionWS")) {
   ...
   public static ConnectionWSPrx checkedCast(ObjectPrx __obj, Map<String, String> __ctx) {
      ...
      if (__obj != null) {
         try {
            ...
            if (__obj.ice_isA("::com::projectgoth::fusion::slice::ConnectionWS", __ctx)) {
               ConnectionWSPrxHelper __h = new ConnectionWSPrxHelper();
               __h.__copyFrom(__obj);
               __d = __h;
            }
