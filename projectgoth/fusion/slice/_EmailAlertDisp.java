...
public abstract class _EmailAlertDisp extends ObjectImpl implements EmailAlert {
   ...
   public final void requestUnreadEmailCount(String username, String password, UserPrx userProxy) {
      this.requestUnreadEmailCount(username, password, userProxy, (Current)null);
   }
   ...
   public DispatchStatus __dispatch(Incoming in, Current __current) {
      ...
      if (pos < 0) {
         ...
         case 4:
            return ___requestUnreadEmailCount(this, in, __current);
         default:
            assert false;
