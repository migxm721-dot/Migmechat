...
public class ModifyPrivacySettings {
   ...
   public static void main(String[] args) throws Exception {
      ...
      getEventSystem(hostname).setReceivingPrivacyMask(username, receivingMask.toEventPrivacySettingIce());
      getEventSystem(hostname).setPublishingPrivacyMask(username, publishingMask.toEventPrivacySettingIce());
      receivingMask = EventPrivacySetting.fromEventPrivacySettingIce(getEventSystem(hostname).getReceivingPrivacyMask(username));
      publishingMask = EventPrivacySetting.fromEventPrivacySettingIce(getEventSystem(hostname).getPublishingPrivacyMask(username));
