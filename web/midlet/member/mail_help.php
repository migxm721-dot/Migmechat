...
<html>
	...
	<body bgcolor="white">
		...
		<br>
<?php
		printf("<p>* SMS notification costs %0.02f %s per SMS.</p>", $cost['price'], $cost['currency']);
?>
		<br>

		<?php
			if(!$bid){
				print '<p><a href="'.$server_root.'/midlet/member/mail_main.php">Back to Mail Main</a></p>';
			}else if($bid == 2){
