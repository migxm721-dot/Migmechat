	...
	<html>
		...
		if ($headers){
			...
			for($i = 0; $i < sizeof($headers); $i++){
				...
				$from = strip_tags($mailHeader->fromaddress);
				...
				if ( ($mailHeader->Unseen == 'U') || ($mailHeader->Recent == 'N') ){
					...
					print '<p><small><b>*&nbsp;<a href="'.$server_root.'/midlet/member/mail_view.php?msg='.trim($mailHeader->Msgno).'&bid='.$bid.'&pagenum='.$pageNum.'">'.$subject.'</a>&gt;&gt; '.date('d M', strtotime($date)).'</b></small></p>';
				} else {
					if($bid == 2){
					...
					print '<p><small>&nbsp;<a href="'.$server_root.'/midlet/member/mail_view.php?msg='.trim($mailHeader->Msgno).'&bid='.$bid.'&pagenum='.$pageNum.'">'.$subject.'</a>&gt;&gt; '.date('d M', strtotime($date)).'</small></p>';
				}
			}
			...
			//First Page
			if ($pageNum > 1){
				print '<a href="'.$server_root.'/midlet/member/mail.php?pagenum=1&bid='.$bid.'">&lt;&lt;</a>&nbsp;';

				//The page before
				print '<a href="'.$server_root.'/midlet/member/mail.php?pagenum='.($pageNum-1).'&bid='.$bid.'">&lt;</a>&nbsp;';
			}
			...
			if ($pageNum < ($totalPages)){
				...
				//Last Page
				print '<a href="'.$server_root.'/midlet/member/mail.php?pagenum='.($totalPages).'&bid='.$bid.'">&gt;&gt;</a>';
			}
			print '</center></p><br>';
		} else {
		...
		if($bid == 2){
			//Sent Items
			if($headers){
				print '<p><a href="'.$server_root.'/midlet/member/mail_deleteall.php?bid='.$bid.'">Delete All &gt;&gt;</a>&nbsp;</p>';
			}
			print '<p><a href="'.$server_root.'/midlet/member/mail_compose.php?bid='.$bid.'">Create New &gt;&gt;</a>&nbsp;</p>';
			print '<p><a href="'.$server_root.'/midlet/member/mail.php?bid=1">Inbox &gt;&gt;</a>&nbsp;</p>';
			print '<p><a href="'.$server_root.'/midlet/member/mail.php?bid=3">Deleted Items &gt;&gt;</a>&nbsp;</p>';
			print '<p><a href="'.$server_root.'/midlet/member/mail_settings.php?bid='.$bid.'">Settings &gt;&gt;</a>&nbsp;</p>';
		}else if($bid == 3){
			//Deleted Items
			if($headers){
				print '<p><a href="'.$server_root.'/midlet/member/mail_deleteall.php?bid='.$bid.'">Delete All &gt;&gt;</a>&nbsp;</p>';
			...
			print '<p><a href="'.$server_root.'/midlet/member/mail_compose.php?bid='.$bid.'">Create New &gt;&gt;</a>&nbsp;</p>';
			print '<p><a href="'.$server_root.'/midlet/member/mail.php?bid=1">Inbox &gt;&gt;</a>&nbsp;</p>';
			print '<p><a href="'.$server_root.'/midlet/member/mail.php?bid=2">Sent Items &gt;&gt;</a>&nbsp;</p>';
			print '<p><a href="'.$server_root.'/midlet/member/mail_settings.php?bid='.$bid.'">Settings &gt;&gt;</a>&nbsp;</p>';
		} else {
			//Inbox
			print '<p><a href="'.$server_root.'/midlet/member/mail.php?bid=1">Refresh Inbox</a></p>';
			if($headers){
				print '<p><a href="'.$server_root.'/midlet/member/mail_deleteall.php?bid='.$bid.'">Delete All &gt;&gt;</a>&nbsp;</p>';
			}
			print '<p><a href="'.$server_root.'/midlet/member/mail_compose.php?bid='.$bid.'">Create New &gt;&gt;</a>&nbsp;</p>';
		...
		print '<p><a href="'.$server_root.'/midlet/member/mail_help.php?bid='.$bid.'&pagenum='.$pageNum.'">Help &gt;&gt;</a>&nbsp;</p>';
	?>
		</body>
	</html>
<?php
	...
	<html>
		...
		<body bgcolor="white">
			<?php
				...
				if($bid == 2){
					print '<p><a href="'.$server_root.'/midlet/member/mail.php?bid=2&pagenum='.$pageNum.'">Back to Sent Items</a></p>';
				}else if($bid == 3){
					print '<p><a href="'.$server_root.'/midlet/member/mail.php?bid=3&pagenum='.$pageNum.'">Back to Deleted Items</a></p>';
				} else {
					print '<p><a href="'.$server_root.'/midlet/member/mail.php?bid=1&pagenum='.$pageNum.'">Back to Inbox</a></p>';
				}
			?>
		</body>
	</html>
