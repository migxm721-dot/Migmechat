...
/*
$Id: nusoap.php,v 1.1 2007/03/23 02:18:09 dgeer Exp $
...
* @version  $Id: nusoap.php,v 1.1 2007/03/23 02:18:09 dgeer Exp $
* @access   public
*/
class nusoap_base {
	/**
...
class nusoapclient extends nusoap_base  {
	...
	var $response_timeout = 5;		// HTTP response timeout
	...
	* @access   public
	*/
	function nusoapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 5){
		parent::nusoap_base();
