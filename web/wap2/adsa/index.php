...
?>
	<div id="content">
		<div class="section">
			...
			<p><b><a href="<?php echo get_server_root(); ?>/sites/index.php?c=registration&a=register&v=wap&from=adsad">Download</a>, register and get R 3.5 for FREE mobile downloads of:</b>
			<ul>
			...
			<b><a href="<?php echo get_server_root(); ?>/sites/index.php?c=registration&a=register&v=wap&from=adsad">Download mig33 NOW</a>,<br/>
