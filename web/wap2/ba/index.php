...
?>
	<div id="content">
		<div class="section">
			...
			<p><b><a href="<?php echo get_server_root(); ?>sites/index.php?c=registration&a=register&v=wap&from=bad">Download</a> to get FREE Mobile Content worth Rs. 20/-!!!</b>
			<ul>
			...
			<b><a href="<?php echo get_server_root(); ?>/sites/index.php?c=registration&a=register&v=wap&from=bad">Download mig33 NOW</a>,<br/>
