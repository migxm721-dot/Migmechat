 ...
 */
@Persistent
public class PhotoUploadedUserEvent
extends UserEvent {
    public static final String EVENT_NAME = "PHOTO_UPLOADED";
    private static Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(PhotoUploadedUserEvent.class));
    ...
    public PhotoUploadedUserEventIce toIceEvent() {
        ...
        PhotoUploadedUserEventIce iceEvent = new PhotoUploadedUserEventIce(this.getTimestamp(), this.getGeneratingUsername(), null, this.getText(), this.scrapbookid, this.title);
        return iceEvent;
    }
