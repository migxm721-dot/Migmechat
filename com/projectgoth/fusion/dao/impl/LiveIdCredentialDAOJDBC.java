...
public class LiveIdCredentialDAOJDBC
extends MigJdbcDaoSupport
implements LiveIdCredentialDAO {
    public LiveIdCredential getCredential(String username) {
        try {
            return (LiveIdCredential)this.getJdbcTemplate().queryForObject(this.getExternalizedQuery("LiveIdCredentialDAO.getCredential"), new Object[]{username}, (RowMapper)new LiveIdCredentialRowMapper());
        }
    ...
    private static final class LiveIdCredentialRowMapper
