...
import com.projectgoth.fusion.dao.impl.VariableTableName;
import java.util.Calendar;
import javax.sql.DataSource;
import org.apache.log4j.Logger;
import org.springframework.jdbc.core.JdbcTemplate;

public class DailyVariableTableName
extends VariableTableName {
    ...
    public synchronized void updateTableName() {
        ...
        if (log.isDebugEnabled()) {
            log.debug((Object)("table name was updated, now " + newTableName));
        }
    }
}
