...
public class VasDAOJDBC
extends MigJdbcDaoSupport
implements VasDAO {
    private Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(VasDAOJDBC.class));

    public void init() {
        this.log.info((Object)"Initialize data generation for VAS Partners");
        ...
        this.log.info((Object)"[DONE] Initialize data generation for VAS Partners");
    }

    public void generateUniqueUsers() {
        this.log.info((Object)"Generating UniqueUsers for VAS Partners");
        ...
        this.log.debug((Object)("[QUERY] " + query));
        this.getJdbcTemplate().execute(query);
        this.log.info((Object)"[DONE] Generating UniqueUsers for VAS Partners");
    }

    public void generateRegistration() {
        this.log.info((Object)"Generating Registration for VAS Partners");
        ...
        this.log.debug((Object)("[QUERY] " + query));
        this.getJdbcTemplate().execute(query);
        this.log.info((Object)"[DONE] Generating Registration for VAS Partners");
    }

    public void generateAuthentication() {
        this.log.info((Object)"Generating Authentication for VAS Partners");
        ...
        this.log.debug((Object)("[QUERY] " + query));
        this.getJdbcTemplate().execute(query);
        this.log.info((Object)"[DONE] Generating Authentication for VAS Partners");
    }

    public void generateActiveUsers() {
        this.log.info((Object)"Generating ActiveUsers for VAS Partners");
        ...
        this.log.debug((Object)("[QUERY] " + query1));
        ...
        this.log.debug((Object)("[QUERY] " + query2));
        this.getJdbcTemplate().execute(query2);
        this.log.info((Object)"[DONE] Generating ActiveUsers for VAS Partners");
    }

    public void generateCreditSpending() {
        this.log.info((Object)"Generating Credit Spending for VAS Partners");
        ...
        this.log.debug((Object)("[QUERY] " + query));
        this.getJdbcTemplate().execute(query);
        this.log.info((Object)"[DONE] Generating Credit Spending for VAS Partners");
    }
}
