...
public class FusionPktSetChatName
extends FusionPktDataSetChatName {
    private static final Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(FusionPktSetChatName.class));
    ...
    public FusionPktSetChatName(String chatID, byte chatType, String chatName) {
        ...
        this.setDestinationType(ChatDestinationType.fromValue((int)chatType));
