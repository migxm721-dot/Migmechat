...
public class FusionPktResendVerificationCode
extends FusionRequest {
    ...
    protected FusionPacket[] processRequest(ConnectionI connection) {
        try {
            ...
            return new FusionPktError(this.transactionId, FusionPktError.Code.UNDEFINED, "Failed to resend activation code - " + RMIExceptionHelper.getRootMessage(e)).toArray();
        }
    }
}
