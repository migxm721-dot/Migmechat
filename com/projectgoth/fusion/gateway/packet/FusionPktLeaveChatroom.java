...
public class FusionPktLeaveChatroom
extends FusionPktDataLeaveChatroom {
    private static final Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(FusionPktLeaveChatroom.class));
