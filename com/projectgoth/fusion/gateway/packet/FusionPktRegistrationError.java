...
public class FusionPktRegistrationError
extends FusionPacket {
    ...
    public FusionPktRegistrationError(short transactionId, String error, CaptchaService captchaService) throws IOException {
        super((short)104, transactionId);
        Captcha captcha;
        boolean randomizeCaptchaWordLength = SystemProperty.getBool(SystemPropertyEntities.Registration.RANDOMIZE_MIDLET_REGISTRATION_CAPTCHA_ENABLED);
