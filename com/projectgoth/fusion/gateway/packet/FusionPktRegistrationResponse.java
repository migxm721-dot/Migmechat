...
public class FusionPktRegistrationResponse
extends FusionRequest {
    ...
    public String getPacketUnsupportedMessage() {
        return SystemProperty.get(SystemPropertyEntities.Registration.MOBILE_REGISTRATION_DISABLED_MESSAGE);
    }
    ...
    protected FusionPacket[] processRequest(ConnectionI connection) {
        try {
            ...
            ConnectionI connectionI = connection;
            ...
            if ((dob = this.getDateOfBirth()) != null) {
                newRegistrationPkt.setDateOfBirth(dob);
            }
            if ((mobileDevice = this.getMobileDevice()) != null) {
            ...
            for (int i = 0; i < returnPkts.length; ++i) {
                ...
                if (pkt.getType() != 0 || pkt.getTransactionId() != this.transactionId) continue;
