...
import com.projectgoth.fusion.fdl.packets.FusionPktDataRemoveContact;
...
public class FusionPktRemoveContact
extends FusionPktDataRemoveContact {
    private static final Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(FusionPktRemoveContact.class));

    public FusionPktRemoveContact() {
    }

    public FusionPktRemoveContact(ByteBuffer byteBuffer) throws IOException {
        super(byteBuffer);
    }

    public FusionPktRemoveContact(FusionPacket packet) {
        super(packet);
    }
