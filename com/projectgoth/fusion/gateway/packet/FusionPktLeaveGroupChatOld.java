...
public class FusionPktLeaveGroupChatOld
extends FusionRequest {
    private static final Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(FusionPktLeaveGroupChatOld.class));
