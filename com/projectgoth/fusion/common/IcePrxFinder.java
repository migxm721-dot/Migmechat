...
public class IcePrxFinder
implements Serializable {
    private static final Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(IcePrxFinder.class));
    ...
    public RegistryPrx getRegistry(boolean relocate) throws RegistryNotFoundException {
        if (this.registryPrx == null || relocate) {
            if (this.iceCommunicator == null) {
                throw new RegistryNotFoundException("Ice communicator has not been initialized");
            }
            if (this.registryLocation == null) {
                throw new RegistryNotFoundException("No registry location found in configuration file");
            }
            ...
            if (this.registryPrx == null) {
                throw new RegistryNotFoundException("Invalid registry proxy");
            }
        }
    ...
    public UserPrx findUserPrx(String username) throws Exception {
        ...
        try {
            ...
            log.error((Object)"failed to get user proxy from registry ", (Throwable)e);
            throw new Exception("Failed to get user proxy from registry - " + e.getMessage());
        }
            ...
            try {
                ...
                log.error((Object)"failed to get user proxy from registry ", (Throwable)ie);
                throw new Exception("Failed to get user proxy from registry - " + ie.getMessage());
            }
        }
    }
    ...
    public ConnectionPrx findConnectionPrx(String sessionId) throws Exception {
        ...
        try {
            ...
            log.error((Object)"failed to get connection proxy from registry ", (Throwable)e);
            throw new Exception("Failed to get connection proxy from registry - " + e.getMessage());
        }
        catch (ObjectNotFoundException e) {
            return null;
        }
            ...
            try {
                ...
                log.error((Object)"failed to get connection proxy from registry ", (Throwable)ie);
                throw new Exception("Failed to get connection proxy from registry - " + ie.getMessage());
            }
        }
    }
    ...
    public ChatRoomPrx findChatRoomPrx(String name) throws Exception {
        ...
        try {
            ...
            throw new Exception("Failed to get chat room proxy from registry - " + e.getMessage());
        }
        catch (ObjectNotFoundException e) {
            return null;
        }
            ...
            try {
                ...
                throw new Exception("Failed to get chat room proxy from registry - " + ie.getMessage());
            }
        }
    }
    ...
    public synchronized UserNotificationServicePrx waitForUserNotificationServiceProxy() {
        while (this.userNotificationServicePrx == null) {
            try {
                ...
                if (this.userNotificationServicePrx != null) continue;
                log.warn((Object)"Still waiting for user notification service...");
                Thread.sleep(500L);
            }
            catch (Exception e) {
                log.error((Object)"retrying after failure to get user notification service", (Throwable)e);
                try {
                    Thread.sleep(500L);
                }
    ...
    public synchronized AuthenticationServicePrx getAuthenticationServiceProxy() throws Exception {
        if (this.authenticationServicePrx == null) {
            ...
            if (!StringUtils.hasLength((String)this.authenticationServiceLocation)) {
    ...
    public synchronized AuthenticationServicePrx waitForAuthenticationServiceProxy() {
        while (this.authenticationServicePrx == null) {
            try {
                ...
                if (this.authenticationServicePrx != null) continue;
                log.warn((Object)"Still waiting for authentication service...");
                Thread.sleep(500L);
            }
            catch (Exception e) {
                log.error((Object)"retrying after failure to get authentication service", (Throwable)e);
                try {
                    Thread.sleep(500L);
                }
                catch (InterruptedException interruptedException) {}
    ...
    public synchronized ReputationServicePrx getReputationServiceProxy() throws Exception {
        if (this.reputationServicePrx == null) {
            ...
            if (!StringUtils.hasLength((String)this.reputationServiceLocation)) {
    ...
    public synchronized ReputationServicePrx waitForReputationServiceProxy() {
        while (this.reputationServicePrx == null) {
            try {
                ...
                if (this.reputationServicePrx != null) continue;
                log.warn((Object)"Still waiting for reputation service...");
                Thread.sleep(500L);
            }
            catch (Exception e) {
                log.error((Object)"retrying after failure to get reputation service", (Throwable)e);
                try {
                    Thread.sleep(500L);
                }
                catch (InterruptedException interruptedException) {}
    ...
    public synchronized RecommendationGenerationServicePrx getRecommendationGenerationServiceProxy() throws Exception {
        if (this.recommendationGenerationServicePrx == null) {
            ...
            if (!StringUtils.hasLength((String)this.recommendationGenerationServiceLocation)) {
    ...
    public synchronized RecommendationGenerationServicePrx waitForRecommendationGenerationServiceProxy() {
        while (this.recommendationGenerationServicePrx == null) {
            try {
                ...
                if (this.recommendationGenerationServicePrx != null) continue;
                log.warn((Object)"Still waiting for recommendation generation service...");
                Thread.sleep(500L);
            }
            catch (Exception e) {
                log.error((Object)"retrying after failure to get recommendation generation service", (Throwable)e);
                try {
                    Thread.sleep(500L);
                }
                catch (InterruptedException interruptedException) {}
    ...
    private class RegistryNotFoundException
    extends Exception {
