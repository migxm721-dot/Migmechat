...
implements Serializable {
    ...
    public final VoiceCapabilityEnum voiceCapability = VoiceCapabilityEnum.NOT_AVAILABLE;
    ...
    public ContactData(ResultSet rs) throws SQLException {
        ...
        if ((intval = (Integer)rs.getObject("contact.defaultPhoneNumber")) != null) {
            this.defaultPhoneNumber = PhoneNumberType.fromValue(intval);
        }
        if ((intval = (Integer)rs.getObject("contact.displayOnPhone")) != null) {
            this.displayOnPhone = intval != 0;
        }
        if ((intval = (Integer)rs.getObject("contact.status")) != null) {
            this.status = StatusEnum.fromValue(intval);
        }
    }

    public ContactData(ContactDataIce contactIce) {
        this.id = contactIce.id == Integer.MIN_VALUE ? null : Integer.valueOf(contactIce.id);
        ...
        Integer n = this.contactGroupId = contactIce.contactGroupId == Integer.MIN_VALUE ? null : Integer.valueOf(contactIce.contactGroupId);
        Boolean bl = contactIce.shareMobilePhone == Integer.MIN_VALUE ? null : (this.shareMobilePhone = Boolean.valueOf(contactIce.shareMobilePhone == 1));
        this.displayOnPhone = contactIce.displayOnPhone == Integer.MIN_VALUE ? null : Boolean.valueOf(contactIce.displayOnPhone == 1);
        this.status = contactIce.status == Integer.MIN_VALUE ? null : StatusEnum.fromValue(contactIce.status);
    ...
    public ContactDataIce toIceObject() {
        ...
        contactIce.defaultIM = this.defaultIM == null ? Integer.MIN_VALUE : (int)this.defaultIM.value();
        contactIce.defaultPhoneNumber = this.defaultPhoneNumber == null ? Integer.MIN_VALUE : (int)this.defaultPhoneNumber.value();
        int n = contactIce.contactGroupId = this.contactGroupId == null ? Integer.MIN_VALUE : this.contactGroupId;
        int n2 = this.shareMobilePhone == null ? Integer.MIN_VALUE : (contactIce.shareMobilePhone = this.shareMobilePhone != false ? 1 : 0);
        contactIce.displayOnPhone = this.displayOnPhone == null ? Integer.MIN_VALUE : (this.displayOnPhone != false ? 1 : 0);
        contactIce.status = this.status == null ? Integer.MIN_VALUE : this.status.value();
        contactIce.fusionPresence = this.fusionPresence == null ? Integer.MIN_VALUE : (int)this.fusionPresence.value();
        contactIce.msnPresence = this.msnPresence == null ? Integer.MIN_VALUE : (int)this.msnPresence.value();
        contactIce.aimPresence = this.aimPresence == null ? Integer.MIN_VALUE : (int)this.aimPresence.value();
        contactIce.yahooPresence = this.yahooPresence == null ? Integer.MIN_VALUE : (int)this.yahooPresence.value();
        contactIce.facebookPresence = this.facebookPresence == null ? Integer.MIN_VALUE : (int)this.facebookPresence.value();
        contactIce.gtalkPresence = this.gtalkPresence == null ? Integer.MIN_VALUE : (int)this.gtalkPresence.value();
    ...
    public static enum VoiceCapabilityEnum {
        ...
        public static VoiceCapabilityEnum fromValue(int value) {
            for (VoiceCapabilityEnum e : VoiceCapabilityEnum.values()) {
