...
implements Serializable {
    ...
    public static PotStakeData fromResultSetWithUserName(ResultSet rs) throws SQLException {
        PotStakeData potStakeData = PotStakeData.fromResultSet(rs);
    ...
    public void addToAmount(double amount, double fundedAmount) {
        PotStakeData potStakeData = this;
        potStakeData.amount = potStakeData.amount + amount;
        potStakeData = this;
        potStakeData.fundedAmount = potStakeData.fundedAmount + fundedAmount;
    }
