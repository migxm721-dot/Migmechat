...
import com.projectgoth.fusion.slice.ImageServerStatsHolder;
 ...
 */
public final class _ImageServerAdminDelD
extends _ObjectDelD
implements _ImageServerAdminDel {
    /*
    ...
    public ImageServerStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionException {
        ...
        final ImageServerStatsHolder __result = new ImageServerStatsHolder();
        Direct __direct = null;
        try {
            ImageServerStats imageServerStats;
            __direct = new Direct(__current){

                public DispatchStatus run(Object __obj) {
                    ImageServerAdmin __servant = null;
                    try {
                        __servant = (ImageServerAdmin)__obj;
                    }
            ...
            try {
                ...
                imageServerStats = __result.value;
