...
import com.projectgoth.fusion.slice.EventSystemStatsHolder;
 ...
 */
public final class _EventSystemAdminDelM
extends _ObjectDelM
implements _EventSystemAdminDel {
    /*
    ...
    public EventSystemStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionException {
        EventSystemStats eventSystemStats;
        ...
        try {
            ...
            try {
                ...
                EventSystemStatsHolder __ret = new EventSystemStatsHolder();
                __is.readObject((Patcher)__ret.getPatcher());
                __is.readPendingObjects();
                __is.endReadEncaps();
                eventSystemStats = __ret.value;
            }
