...
import com.projectgoth.fusion.slice._AuthenticationServiceOperations;

public class _AuthenticationServiceTie
...
implements TieBase {
    ...
    public boolean equals(Object rhs) {
        ...
        if (!(rhs instanceof _AuthenticationServiceTie)) {
            return false;
        }
        return this._ice_delegate.equals(((_AuthenticationServiceTie)rhs)._ice_delegate);
    }
