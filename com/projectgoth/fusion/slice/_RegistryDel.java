...
extends _ObjectDel {
    public UserPrx findUserObject(String var1, Map<String, String> var2) throws LocalExceptionWrapper, ObjectNotFoundException;

    public UserPrx[] findUserObjects(String[] var1, Map<String, String> var2) throws LocalExceptionWrapper;

    public Map<String, UserPrx> findUserObjectsMap(String[] var1, Map<String, String> var2) throws LocalExceptionWrapper;
    ...
    public ConnectionPrx findConnectionObject(String var1, Map<String, String> var2) throws LocalExceptionWrapper, ObjectNotFoundException;
    ...
    public ChatRoomPrx findChatRoomObject(String var1, Map<String, String> var2) throws LocalExceptionWrapper, ObjectNotFoundException;

    public ChatRoomPrx[] findChatRoomObjects(String[] var1, Map<String, String> var2) throws LocalExceptionWrapper;
    ...
    public GroupChatPrx findGroupChatObject(String var1, Map<String, String> var2) throws LocalExceptionWrapper, ObjectNotFoundException;
    ...
    public ObjectCachePrx getLowestLoadedObjectCache(Map<String, String> var1) throws LocalExceptionWrapper, ObjectNotFoundException;
    ...
    public BotServicePrx getLowestLoadedBotService(Map<String, String> var1) throws LocalExceptionWrapper, ObjectNotFoundException;
    ...
    public int newGatewayID(Map<String, String> var1) throws LocalExceptionWrapper;
    ...
    public int getUserCount(Map<String, String> var1) throws LocalExceptionWrapper;
