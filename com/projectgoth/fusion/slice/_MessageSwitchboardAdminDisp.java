...
import com.projectgoth.fusion.slice.MessageSwitchboardAdmin;
import com.projectgoth.fusion.slice.MessageSwitchboardStats;
import java.util.Arrays;

public abstract class _MessageSwitchboardAdminDisp
extends ObjectImpl
implements MessageSwitchboardAdmin {
    ...
    public static DispatchStatus ___getStats(MessageSwitchboardAdmin __obj, Incoming __inS, Current __current) {
        _MessageSwitchboardAdminDisp.__checkMode((OperationMode)OperationMode.Normal, (OperationMode)__current.mode);
    ...
    public DispatchStatus __dispatch(Incoming in, Current __current) {
        ...
        switch (pos) {
            case 0: {
                return _MessageSwitchboardAdminDisp.___getStats(this, in, __current);
            }
            case 1: {
                return _MessageSwitchboardAdminDisp.___ice_id((Object)this, (Incoming)in, (Current)__current);
            }
            case 2: {
                return _MessageSwitchboardAdminDisp.___ice_ids((Object)this, (Incoming)in, (Current)__current);
            }
            case 3: {
                return _MessageSwitchboardAdminDisp.___ice_isA((Object)this, (Incoming)in, (Current)__current);
            }
            case 4: {
                return _MessageSwitchboardAdminDisp.___ice_ping((Object)this, (Incoming)in, (Current)__current);
            }
        }
        assert (false);
        throw new OperationNotExistException(__current.id, __current.facet, __current.operation);
    ...
    public void __write(BasicStream __os) {
        __os.writeTypeId(_MessageSwitchboardAdminDisp.ice_staticId());
