...
implements SessionCache {
    ...
    public final void logSession(SessionIce session, SessionMetricsIce sessionMetrics) {
        this.logSession(session, sessionMetrics, null);
    }

    public static DispatchStatus ___logSession(SessionCache __obj, Incoming __inS, Current __current) {
        _SessionCacheDisp.__checkMode((OperationMode)OperationMode.Normal, (OperationMode)__current.mode);
    ...
    public DispatchStatus __dispatch(Incoming in, Current __current) {
        ...
        switch (pos) {
            case 0: {
                return _SessionCacheDisp.___ice_id((Object)this, (Incoming)in, (Current)__current);
            }
            case 1: {
                return _SessionCacheDisp.___ice_ids((Object)this, (Incoming)in, (Current)__current);
            }
            case 2: {
                return _SessionCacheDisp.___ice_isA((Object)this, (Incoming)in, (Current)__current);
            }
            case 3: {
                return _SessionCacheDisp.___ice_ping((Object)this, (Incoming)in, (Current)__current);
            }
            case 4: {
                return _SessionCacheDisp.___logSession(this, in, __current);
            }
        }
        assert (false);
        throw new OperationNotExistException(__current.id, __current.facet, __current.operation);
    ...
    public void __write(BasicStream __os) {
        __os.writeTypeId(_SessionCacheDisp.ice_staticId());
