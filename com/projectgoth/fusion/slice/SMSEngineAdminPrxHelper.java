...
import com.projectgoth.fusion.slice._SMSEngineAdminDel;
import com.projectgoth.fusion.slice._SMSEngineAdminDelD;
import com.projectgoth.fusion.slice._SMSEngineAdminDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class SMSEngineAdminPrxHelper
extends ObjectPrxHelperBase
implements SMSEngineAdminPrx {
    @Override
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::SMSEngineAdmin")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::SMSEngineAdmin", __ctx)) break block3;
                    SMSEngineAdminPrxHelper __h = new SMSEngineAdminPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static SMSEngineAdminPrx checkedCast(ObjectPrx __obj, String __facet) {
        SMSEngineAdminPrxHelper __d = null;
        if (__obj != null) {
