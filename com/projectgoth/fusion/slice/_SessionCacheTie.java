...
import com.projectgoth.fusion.slice._SessionCacheOperations;

public class _SessionCacheTie
...
implements TieBase {
    ...
    public boolean equals(Object rhs) {
        ...
        if (!(rhs instanceof _SessionCacheTie)) {
            return false;
        }
        return this._ice_delegate.equals(((_SessionCacheTie)rhs)._ice_delegate);
    }
