...
import com.projectgoth.fusion.slice._MessageLoggerAdminDelD;
import com.projectgoth.fusion.slice._MessageLoggerAdminDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class MessageLoggerAdminPrxHelper
extends ObjectPrxHelperBase
implements MessageLoggerAdminPrx {
    @Override
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::MessageLoggerAdmin")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::MessageLoggerAdmin", __ctx)) break block3;
                    MessageLoggerAdminPrxHelper __h = new MessageLoggerAdminPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static MessageLoggerAdminPrx checkedCast(ObjectPrx __obj, String __facet) {
        MessageLoggerAdminPrxHelper __d = null;
        if (__obj != null) {
