 ...
 */
public interface RecommendationDataCollectionServiceAdminPrx
extends ObjectPrx {
    public RecommendationDataCollectionServiceStats getStats() throws FusionExceptionWithRefCode;

    public RecommendationDataCollectionServiceStats getStats(Map<String, String> var1) throws FusionExceptionWithRefCode;
}
