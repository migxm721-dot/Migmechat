...
import com.projectgoth.fusion.slice._UserOperations;

public class _UserTie
extends _UserDisp
implements TieBase {
    ...
    public boolean equals(Object rhs) {
        ...
        if (!(rhs instanceof _UserTie)) {
            return false;
        }
        return this._ice_delegate.equals(((_UserTie)rhs)._ice_delegate);
    }
