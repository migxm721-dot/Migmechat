 ...
 */
public final class _RegistryAdminDelD
extends _ObjectDelD
implements _RegistryAdminDel {
    ...
    public RegistryStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionException {
        ...
        final RegistryStatsHolder __result = new RegistryStatsHolder();
        ...
        try {
            ...
            __direct = new Direct(__current){
                ...
                public DispatchStatus run(Object __obj) {
                    RegistryAdmin __servant = null;
                    try {
                        __servant = (RegistryAdmin)__obj;
                    }
