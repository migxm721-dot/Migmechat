...
import com.projectgoth.fusion.slice._AuthenticationServiceAdminDelD;
import com.projectgoth.fusion.slice._AuthenticationServiceAdminDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class AuthenticationServiceAdminPrxHelper
extends ObjectPrxHelperBase
implements AuthenticationServiceAdminPrx {
    @Override
    ...
    public static AuthenticationServiceAdminPrx checkedCast(ObjectPrx __obj) {
        AuthenticationServiceAdminPrx __d;
        block3: {
            __d = null;
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::AuthenticationServiceAdmin")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::AuthenticationServiceAdmin", __ctx)) break block3;
                    AuthenticationServiceAdminPrxHelper __h = new AuthenticationServiceAdminPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static AuthenticationServiceAdminPrx checkedCast(ObjectPrx __obj, String __facet) {
        AuthenticationServiceAdminPrxHelper __d = null;
        if (__obj != null) {
