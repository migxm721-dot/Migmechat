...
import com.projectgoth.fusion.slice._EmailAlertAdminDelD;
import com.projectgoth.fusion.slice._EmailAlertAdminDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class EmailAlertAdminPrxHelper
extends ObjectPrxHelperBase
implements EmailAlertAdminPrx {
    @Override
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::EmailAlertAdmin")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::EmailAlertAdmin", __ctx)) break block3;
                    EmailAlertAdminPrxHelper __h = new EmailAlertAdminPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static EmailAlertAdminPrx checkedCast(ObjectPrx __obj, String __facet) {
        EmailAlertAdminPrxHelper __d = null;
        if (__obj != null) {
