...
import com.projectgoth.fusion.slice.SMSEngineStatsHolder;
 ...
 */
public final class _SMSEngineAdminDelD
extends _ObjectDelD
implements _SMSEngineAdminDel {
    /*
    ...
    public SMSEngineStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionException {
        ...
        final SMSEngineStatsHolder __result = new SMSEngineStatsHolder();
        Direct __direct = null;
        try {
            SMSEngineStats sMSEngineStats;
            __direct = new Direct(__current){

                public DispatchStatus run(Object __obj) {
                    SMSEngineAdmin __servant = null;
                    try {
                        __servant = (SMSEngineAdmin)__obj;
                    }
