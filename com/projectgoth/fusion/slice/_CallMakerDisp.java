...
public abstract class _CallMakerDisp
extends ObjectImpl
implements CallMaker {
    ...
    public final CallDataIce requestCallback(CallDataIce call, int maxDuration, int retries) throws FusionException {
        return this.requestCallback(call, maxDuration, retries, null);
    }

    public static DispatchStatus ___requestCallback(CallMaker __obj, Incoming __inS, Current __current) {
        _CallMakerDisp.__checkMode((OperationMode)OperationMode.Normal, (OperationMode)__current.mode);
    ...
    public DispatchStatus __dispatch(Incoming in, Current __current) {
        ...
        switch (pos) {
            case 0: {
                return _CallMakerDisp.___ice_id((Object)this, (Incoming)in, (Current)__current);
            }
            case 1: {
                return _CallMakerDisp.___ice_ids((Object)this, (Incoming)in, (Current)__current);
            }
            case 2: {
                return _CallMakerDisp.___ice_isA((Object)this, (Incoming)in, (Current)__current);
            }
            case 3: {
                return _CallMakerDisp.___ice_ping((Object)this, (Incoming)in, (Current)__current);
            }
            case 4: {
                return _CallMakerDisp.___requestCallback(this, in, __current);
            }
        }
        assert (false);
        throw new OperationNotExistException(__current.id, __current.facet, __current.operation);
    ...
    public void __write(BasicStream __os) {
        __os.writeTypeId(_CallMakerDisp.ice_staticId());
