...
import com.projectgoth.fusion.slice.MessageSwitchboardStatsHolder;
 ...
 */
public final class _MessageSwitchboardAdminDelD
extends _ObjectDelD
implements _MessageSwitchboardAdminDel {
    /*
    ...
    public MessageSwitchboardStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionException {
        ...
        final MessageSwitchboardStatsHolder __result = new MessageSwitchboardStatsHolder();
        Direct __direct = null;
        try {
            MessageSwitchboardStats messageSwitchboardStats;
            __direct = new Direct(__current){

                public DispatchStatus run(Object __obj) {
                    MessageSwitchboardAdmin __servant = null;
                    try {
                        __servant = (MessageSwitchboardAdmin)__obj;
                    }
            ...
            try {
                ...
                messageSwitchboardStats = __result.value;
            ...
            __direct.destroy();
            return messageSwitchboardStats;
        }
