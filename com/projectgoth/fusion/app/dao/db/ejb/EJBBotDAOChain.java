...
extends BotDAOChain {
    ...
    public BotData getBot(int botID) throws DAOException {
        ...
        try {
            ...
            log.warn((Object)String.format("Failed to get BotData for bot:%s", botID), (Throwable)e);
            return super.getBot(botID);
        }
    }
}
