...
import com.projectgoth.fusion.reputation.ReputationServiceContext;
...
public class ReputationServiceMain {
    ...
    private static Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(ReputationServiceMain.class));
    private static ApplicationContext context;

    public static void main(String[] args) {
        int status;
        DOMConfigurator.configureAndWatch((String)"log4j.xml");
        log.info((Object)"ReputationService version @version@");
        log.info((Object)"Copyright (c) 2005-2008 Project Goth Inc. All rights reserved");
        context = ReputationServiceContext.getContext();
        ReputationService app = (ReputationService)((Object)context.getBean("reputationService"));
        if (args.length >= 1) {
