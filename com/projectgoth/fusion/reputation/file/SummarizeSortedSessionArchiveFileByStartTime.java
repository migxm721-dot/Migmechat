...
public class SummarizeSortedSessionArchiveFileByStartTime {
    ...
    private void processFile(String filename) throws IOException {
        ...
        TreeMap<Long, AtomicInteger> map = new TreeMap<Long, AtomicInteger>();
        while ((line = reader.readLine()) != null) {
            ...
            int country = Integer.parseInt(parts.get(2));
            if (startDate > currentBracketEndDate) {
                currentBracketStartDate += 300L;
                currentBracketEndDate += 300L;
            }
            if (country != 107 || startDate <= currentBracketStartDate) continue;
