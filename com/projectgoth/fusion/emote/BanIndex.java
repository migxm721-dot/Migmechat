...
extends EmoteCommand {
    ...
    protected EmoteCommand.ResultType execute(MessageData messageData, ChatSource chatSource) throws FusionException {
        ...
        int banIndexMax = SystemProperty.getInt(SystemPropertyEntities.Emote.BAN_INDEX_MAX);
        ...
        String rateLimit = SystemProperty.get(SystemPropertyEntities.Emote.BAN_INDEX_RATE_LIMIT);
