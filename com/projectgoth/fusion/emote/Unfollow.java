...
import com.projectgoth.fusion.emote.Follow;
...
extends EmoteCommand {
    ...
    protected EmoteCommand.ResultType execute(MessageData messageData, ChatSource chatSource) throws FusionException {
        ...
        String rateLimitPerUser = SystemProperty.get(SystemPropertyEntities.Emote.UNFOLLOW_RATE_LIMIT);
        ...
        try {
            ...
            contactBean.removeFusionUserFromContact(userId, messageData.source, contactData.id, true);
        ...
        if (SystemProperty.getBool(SystemPropertyEntities.Emote.LOG_ALL_EMOTES_ENABLED)) {
            ...
            ChatRoomEmoteLogData logData = new ChatRoomEmoteLogData(messageData.source, usernameToUnfollow, args[0], chatroomId, groupId, -1, null);
