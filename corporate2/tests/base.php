...
if (PHP_SAPI == 'cli')
{
	...
	$_SERVER['HTTP_HOST'] = 'login.localhost-devlab.projectgoth.com';
}
 ...
 */
	...
	$packages_path = dirname(__FILE__).'/../../codeigniter/packages';
 ...
 *
 */
	$view_folder = $application_folder;
 ...
 *
 */
	$ciunit_folder = dirname(__FILE__) . '/../../codeigniter/packages/CIUnit';
