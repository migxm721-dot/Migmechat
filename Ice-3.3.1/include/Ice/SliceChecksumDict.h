...
ICE_API void __writeSliceChecksumDict(::IceInternal::BasicStream*, const SliceChecksumDict&);
ICE_API void __readSliceChecksumDict(::IceInternal::BasicStream*, SliceChecksumDict&);
