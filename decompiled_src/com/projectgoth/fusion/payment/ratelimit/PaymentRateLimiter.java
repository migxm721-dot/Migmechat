...
public class PaymentRateLimiter {
    private static final Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(PaymentRateLimiter.class));
    ...
    public <TContext> boolean checkWithoutHit(PaymentRateLimitKeySpace rateLimiterKeySpace, String localKey, long incrValue, long maxHitCount, MemCachedClientWrapper.InitialCounterValueProvider<TContext> initialCounterValueProvider, TContext contextData) {
        ...
        if (log.isDebugEnabled()) {
            log.debug((Object)("rateLimiterKeySpace=" + this.rateLimiterRootKeySpace + ";key=" + key + " hitCount=" + hitCount + ";maxHitcount=" + maxHitCount + ";incrValue=" + incrValue));
        }
    ...
    protected <TContext> HitInstance beginHit(PaymentRateLimitKeySpace rateLimiterKeySpace, String localMainKey, long incrValue, long maxHitCount, long preallocationLifeSpan, Date actionTime, MemCachedClientWrapper.InitialCounterValueProvider<TContext> initialCounterValueProvider, TContext contextData) {
        long prevPreallocationHitCount_mainHitValue;
        ...
        if (mainHitValue > maxHitCount) {
            if (log.isDebugEnabled()) {
                log.debug((Object)("rateLimiterKeySpace=" + this.rateLimiterRootKeySpace + ";mainKey=" + mainKey + ";mainHitValue=" + mainHitValue + ";maxHitCount=" + maxHitCount));
            }
            return null;
        }
        long actionTimeStamp = actionTime.getTime();
        long currentPreallocationTimeSlot = PaymentRateLimiter.getCurrentPreallocationTimeSlot(actionTimeStamp, preallocationLifeSpan);
        ...
        if ((prevPreallocationHitCount_mainHitValue = prevPreallocationHitCount + mainHitValue) > maxHitCount) {
            if (log.isDebugEnabled()) {
                log.debug((Object)("rateLimiterKeySpace=" + this.rateLimiterRootKeySpace + ";mainKey=" + mainKey + ";mainHitValue=" + mainHitValue + ";prevPreallocationSlotKey=" + prevPreallocationSlotKey + ";prevPreallocationHitCount=" + prevPreallocationHitCount + ";maxHitCount=" + maxHitCount));
            }
            return null;
        }
        ...
        if (currentPreallocationHitCount >= 0L && currentPreallocationHitCount + prevPreallocationHitCount_mainHitValue > maxHitCount) {
            if (log.isDebugEnabled()) {
                log.debug((Object)("rateLimiterKeySpace=" + this.rateLimiterRootKeySpace + ";mainKey=" + mainKey + ";mainHitValue=" + mainHitValue + ";prevPreallocationSlotKey=" + prevPreallocationSlotKey + ";prevPreallocationHitCount=" + prevPreallocationHitCount + ";currentPreallocationSlotKey=" + currentPreallocationSlotKey + ";currentPreallocationHitCount=" + currentPreallocationHitCount + ";maxHitCount=" + maxHitCount));
            }
            MemCachedClientWrapper.decr(this.rateLimiterRootKeySpace, currentPreallocationSlotKey, incrValue);
            return null;
        }
        return new HitInstance(incrValue, this.rateLimiterRootKeySpace, mainKey, currentPreallocationSlotKey);
    }

    public <TContext> HitInstance beginHit(PaymentRateLimitKeySpace rateLimiterKeySpace, String localMainKey, long incrValue, long maxHitCount, long preallocationLifeSpan, MemCachedClientWrapper.InitialCounterValueProvider<TContext> initialCounterValueProvider, TContext contextData) {
    ...
    public static class HitInstance {
        ...
        public void end(boolean doConfirm) {
            ...
            if (log.isDebugEnabled()) {
                log.debug((Object)("currentPreallocCount:" + currentPreallocCount));
            }
        }
    }
}
