...
import com.projectgoth.fusion.emote.gift.GiftNotifier;
 ...
 */
public class GiftAllBuyer
implements Callable<Integer>,
Serializable {
    private static Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(GiftAllBuyer.class));
    ...
    public GiftAllBuyer(String buyerUsername, String recipient, UserData recipientUserData, VirtualGiftData gift, int purchaseLocation, boolean privateGift, String message, AccountEntrySourceData accountEntrySourceData, boolean isGiftShower, boolean sendGiftShowerEvent, Integer totalGiftShowerRecipients, IcePrxFinder icePrxFinder, String recipientWithVGReceivedIDMapGUID) {
        if (log.isDebugEnabled()) {
            log.debug((Object)("Constructing GiftAllBuyer: buyer=" + buyerUsername + " recipient=" + recipientUserData));
        }
    ...
    public Integer call() {
        try {
            if (log.isDebugEnabled()) {
                log.debug((Object)("GiftAllBuyer.call: buyer=" + this.buyerUsername + " recipient=" + this.recipientUserData));
            }
            ...
            GiftNotifier notifier = new GiftNotifier(this.buyerUsername, virtualGiftReceivedID, this.recipientUserData, this.gift, this.privateGift, this.message, null, this.isGiftShower, this.sendGiftShowerEvent, this.totalGiftShowerRecipients, this.icePrxFinder);
            Future<Boolean> ignoredFuture = GiftAsync.queueWorker(notifier);
            if (log.isDebugEnabled()) {
                log.debug((Object)"GiftAllBuyer.call: queued GiftNotifier");
            }
            ...
            log.error((Object)("Exception in GiftAllBuyer.call: e=" + e), (Throwable)e);
            return null;
        }
    }
}
