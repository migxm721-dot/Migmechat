...
extends EmoteCommand {
    ...
    protected EmoteCommand.ResultType execute(MessageData messageData, ChatSource chatSource) throws FusionException {
        ...
        super.checkRateLimit(Ban.class, "t:" + args[1] + ":" + roomData.id + ":" + roomData.groupID, SystemProperty.get(SystemPropertyEntities.Emote.BAN_RATE_LIMIT));
        List<String> list = Arrays.asList(args).subList(1, args.length - 1);
