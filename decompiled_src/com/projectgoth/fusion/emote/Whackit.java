...
public class Whackit
extends EmoteCommand {
    private static Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(Whackit.class));
    ...
    private static final String DEFAULT_WHACKIT_VALUES = StringUtil.join(new String[]{"1-10:Useless - Is that all you got?", "11-20:Pathetic - You can do better than that!", "21-30:Weak - Whack it harder!", "31-40:Powerless - Are you tired already??", "41-50:Average - You know you want to go higher!", "51-60:Strong - Almost there! More!", "61-70:Mighty - You are doing great!", "71-80:Powerful - Well done! Beat the others!", "81-90:Awesome - Great job! Keep it up!", "91-99:Amazing - Wow! You're a power machine!", "100-100:Supreme - Woohoo! You are superhuman!"}, ";;;");
    ...
    protected EmoteCommand.ResultType execute(MessageData messageData, ChatSource chatSource) throws FusionException {
        ...
        String[] values = whackitString.split(WHACKIT_VALUE_SEPARATOR);
        ...
        for (int i = 0; i < values.length; ++i) {
            ...
            if (strength < start || strength > end) continue;
        ...
        log.error((Object)String.format("Failed to handle /whackit emote: user=%s, strength=%d, values=%s", chatSource.getParentUsername(), strength, whackitString));
