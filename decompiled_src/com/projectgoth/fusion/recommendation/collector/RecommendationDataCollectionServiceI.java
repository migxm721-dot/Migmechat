...
public class RecommendationDataCollectionServiceI
extends _RecommendationDataCollectionServiceDisp {
    private static final Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(RecommendationDataCollectionServiceI.class));
