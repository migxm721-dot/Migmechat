...
public class ShowPrivacySettings {
    ...
    public static void main(String[] args) throws Exception {
        ...
        EventPrivacySetting receivingMask = EventPrivacySetting.fromEventPrivacySettingIce(ShowPrivacySettings.getEventSystem(hostname).getReceivingPrivacyMask(username));
        EventPrivacySetting publishingMask = EventPrivacySetting.fromEventPrivacySettingIce(ShowPrivacySettings.getEventSystem(hostname).getPublishingPrivacyMask(username));
