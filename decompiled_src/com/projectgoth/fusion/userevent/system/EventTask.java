...
public class EventTask {
    private static final Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(EventTask.class));
    ...
    protected void assignDisplayPicture(UserEventIce event) {
        ...
        if (log.isDebugEnabled()) {
            log.debug((Object)("display picture set to [" + event.generatingUserDisplayPicture + "] for user [" + event.generatingUsername + "]"));
        }
    }
