...
public class FusionPktGetServerQuestionOld
    ...
    protected FusionPacket[] processRequest(ConnectionI connection) {
        try {
            ...
            if (alertMessage != null) {
                return new FusionPacket[]{new FusionPktServerQuestionOld(alertMessage, this.transactionId)};
            }
            return new FusionPacket[]{new FusionPktServerQuestionOld(this.transactionId)};
        }
        catch (Exception e) {
