...
public class FusionPktPresence
extends FusionPktDataPresence {
    ...
    public FusionPktPresence(int contactID, int imTypeValue, int presenceValue, ConnectionI connection) {
        ...
        ImType imType = ImType.fromValue((int)((byte)imTypeValue));
        PresenceType presence = PresenceType.fromValue((int)((byte)presenceValue));
