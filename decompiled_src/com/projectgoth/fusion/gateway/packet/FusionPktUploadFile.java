...
public class FusionPktUploadFile
extends FusionPktDataUploadFile {
    ...
    protected FusionPacket[] processRequest(ConnectionI connection) {
        try {
            ...
            if (fileType != FusionPktDataUploadFile.FileType.IMAGE) {
                throw new Exception("Unsupported file type " + (Object)((Object)fileType));
            }
            ...
            if (useAsDisplayPicture != null && useAsDisplayPicture.booleanValue()) {
