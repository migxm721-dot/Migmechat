...
public class FusionPktMidletTab
extends FusionPacket {
    private static Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(FusionPktMidletTab.class));
    ...
    public static FusionPktMidletTab newUserRegistrationWizardTab(short transactionId, boolean mobileVerified, ClientType deviceType) throws CreateException, RemoteException {
        ...
        return new FusionPktMidletTab(transactionId, url, (byte)(mobileVerified ? 1 : 0));
    }
    ...
    public static FusionPktMidletTab newHomeTab(short transactionId) throws CreateException, RemoteException {
        ...
        return new FusionPktMidletTab(transactionId, url, 0);
    }
