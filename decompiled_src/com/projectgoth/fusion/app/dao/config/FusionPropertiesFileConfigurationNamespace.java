 ...
 *  com.projectgoth.configuration.PropertiesFileConfigurationNamespace
 */
package com.projectgoth.fusion.app.dao.config;

import com.projectgoth.configuration.PropertiesFileConfigurationNamespace;

public class FusionPropertiesFileConfigurationNamespace
extends PropertiesFileConfigurationNamespace {
    ...
    protected final String getPath() {
        return System.getProperty(CONFIG_DIR_PROPNAME, DEFAULT_CONFIG_DIR);
    }
}
