 ...
 */
public class LeaderboardDAOJDBC
extends MigJdbcDaoSupport
implements LeaderboardDAO {
    private Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(LeaderboardDAOJDBC.class));
    private int lastLoginDayLength = 14;

    @Override
    public List<String> getLastLoggedInForRedis(int days) {
        return this.getJdbcTemplate().query(this.getExternalizedQuery("LeaderboardDAO.getLastLoggedInUsersForRedis"), new Object[]{days}, (RowMapper)new UserLoggedInRowMapper());
    }

    @Override
    public List<String[]> getLastLoggedInUserScoreForRedis(int days) {
        return this.getJdbcTemplate().query(this.getExternalizedQuery("LeaderboardDAO.getLastLoggedInUserScoreForRedis"), new Object[]{days}, (RowMapper)new UserLoggedInScoreRowMapper());
    }
    ...
    public void generateLeaderboard(int leaderboardId) {
        ...
        switch (leaderboardId) {
            case 1: {
                this.log.info((Object)"Generating leaderboard for ProfileLikesAllTime");
                this.generateLeaderboardProfileLikesAllTime(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for ProfileLikesAllTime");
                break;
            }
            case 2: {
                this.log.info((Object)"Generating leaderboard for MigLevelAllTime");
                this.generateLeaderboardMigLevelAllTime(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for MigLevelAllTime");
                break;
            }
            case 3: {
                this.log.info((Object)"Generating leaderboard for ReferrerAllTime");
                this.generateLeaderboardReferrerAllTime(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for ReferrerAllTime");
                break;
            }
            case 4: {
                this.log.info((Object)"Generating leaderboard for ReferrerWeekly");
                this.generateLeaderboardReferrerWeekly(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for ReferrerWeekly");
                break;
            }
            case 5: {
                this.log.info((Object)"Generating leaderboard for GiftReceiverAllTime");
                this.generateLeaderboardGiftReceiverAllTime(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for GiftReceiverAllTime");
                break;
            }
            case 6: {
                this.log.info((Object)"Generating leaderboard for GiftReceiverWeekly");
                this.generateLeaderboardGiftReceiverWeekly(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for GiftReceiverWeekly");
                break;
            }
            case 7: {
                this.log.info((Object)"Generating leaderboard for GiftSenderAllTime");
                this.generateLeaderboardGiftSenderAllTime(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for GiftSenderAllTime");
                break;
            }
            case 8: {
                this.log.info((Object)"Generating leaderboard for GiftSenderWeekly");
                this.generateLeaderboardGiftSenderWeekly(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for GiftSenderWeekly");
                break;
            }
            case 9: {
                this.log.info((Object)"Generating leaderboard for GroupLikesAllTime");
                this.generateLeaderboardGroupLikesAllTime(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for GroupLikesAllTime");
                break;
            }
            case 10: {
                this.log.info((Object)"Generating leaderboard for GroupPhotosAllTime");
                this.generateLeaderboardGroupPhotosAllTime(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for GroupPhotosAllTime");
                break;
            }
            case 11: {
                this.log.info((Object)"Generating leaderboard for GroupTopicsAllTime");
                this.generateLeaderboardGroupTopicsAllTime(directory, date, dateFormat);
                this.log.info((Object)"[DONE] Generating leaderboard for GroupTopicsAllTime");
            }
        }
    }
    ...
    private static final class UserLoggedInScoreRowMapper
    ...
    private static final class UserLoggedInRowMapper
    implements RowMapper {
