...
public class InvitationDetailsData
implements Serializable {
    ...
    public void setCreatedTime(String str) throws ParseException {
        this.createdTS = str == null ? null : DateTimeUtils.getInvitationTimeFromString(str);
    }
    ...
    public void setExpiredTime(String str) throws ParseException {
        this.expiredTS = str == null ? null : DateTimeUtils.getInvitationTimeFromString(str);
    }
}
