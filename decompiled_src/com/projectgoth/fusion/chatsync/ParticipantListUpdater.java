 ...
 */
public class ParticipantListUpdater
extends ParticipantList {
    private static final LogFilter log = new LogFilter(Logger.getLogger((String)ConfigUtils.getLoggerName(ParticipantListUpdater.class)), SystemPropertyEntities.ChatSyncSettings.LOG_EXCLUSION_FILTER);
    ...
    public void storePipeline(ChatSyncStore pipelineStore) throws FusionException {
        ...
        if (this.addUsername != null) {
            pipelineStore.zadd((ChatSyncEntity)this, (double)System.currentTimeMillis(), this.addUsername);
            ++this.writeOpCount;
        }
