...
implements Serializable {
    ...
    public ApproveTypeEnum autoApprove;
    ...
    private static final Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(CreditCardPaymentData.class));

    public CreditCardPaymentData() {
        this.allowAutoApprove = true;
        this.autoApprove = ApproveTypeEnum.MANUAL;
    }
    ...
    public CreditCardPaymentData(ResultSet rs) throws SQLException {
        ...
        if (intValue != null) {
            this.autoApprove = ApproveTypeEnum.fromValue(intValue);
        }
        if (this.autoApprove != ApproveTypeEnum.AUTO) {
            this.allowAutoApprove = false;
        }
        if ((intValue = (Integer)rs.getObject("source")) != null) {
            this.source = SourceEnum.fromValue(intValue);
        }
        if ((intValue = (Integer)rs.getObject("cardType")) != null) {
            this.cardType = CardTypeEnum.fromValue(intValue);
        }
        ...
        try {
            ...
            log.error((Object)("unable to deserialize creditcard payment details for id " + this.id + " [" + details + "]"));
        }
    }

    public Integer getGlobalCollectPaymentProductId() {
        return CreditCardPaymentData.getGlobalCollectPaymentProductId(this.cardType);
    }

    public static Integer getGlobalCollectPaymentProductId(CardTypeEnum cardType) {
        switch (cardType) {
            case VISA: {
                return 1;
            }
    ...
    public String getGlobalCollectMerchantId() {
        if (this.providerTransactionId == null || this.providerTransactionId.length() < 10) {
            return null;
        }
        return this.providerTransactionId.substring(6, 10);
    }
    ...
    public void decline(ErrorEnum errorResponse) {
        this.status = StatusEnum.DECLINED;
    ...
    public void decline(ErrorEnum errorResponse, String args) {
        this.status = StatusEnum.DECLINED;
    ...
    public void deserializeDetails(String details) throws JSONException {
        ...
        if ((val = jsonDetails.getString("firstname")) != null) {
            this.firstName = val;
        }
    }
    ...
    public JSONObject serializeExtraFieldsToJSON() throws JSONException {
        ...
        jsonObj.put("lastname", (Object)this.lastName);
        jsonObj.put("firstname", (Object)this.firstName);
        return jsonObj;
    }
    ...
    public static enum ApproveTypeEnum {
        ...
        public static ApproveTypeEnum fromValue(int value) {
    ...
    public static enum ErrorEnum {
        ...
        public String message(Locale locale) throws Exception {
            try {
                return MessageBundle.getMessage(MESSAGES_BUNDLE_NAME, locale, this.name());
            }
            catch (Exception e) {
                log.error((Object)("message error: " + e.getMessage()));
        ...
        public String message(Locale locale, Object ... parameters) throws Exception {
            try {
                return MessageBundle.getMessage(MESSAGES_BUNDLE_NAME, locale, this.name(), parameters);
            }
            catch (Exception e) {
                log.error((Object)("message error: " + e.getMessage()));
                return DEFAULT_ERROR_MESSAGE;
        ...
        public static ErrorEnum fromValue(int value) {
        ...
        static {
            log = Logger.getLogger((String)ConfigUtils.getLoggerName(CreditCardPaymentData.class));
        }
    }
    ...
    public static enum SourceEnum {
        ...
        public static SourceEnum fromValue(int value) {
