...
implements Serializable {
    ...
    public MidletAcceptTypeEnum midletAcceptType;
    public String midp;
    public String cldc;
    ...
    public HandsetData(ResultSet rs) throws SQLException {
        ...
        if ((intVal = (Integer)rs.getObject("filesystemsupport")) != null) {
            this.fileSystemSupport = intVal != 0;
        }
        if ((intVal = (Integer)rs.getObject("pngsupport")) != null) {
            this.pngSupport = intVal != 0;
        }
        if ((intVal = (Integer)rs.getObject("gifsupport")) != null) {
            this.gifSupport = intVal != 0;
        }
        if ((intVal = (Integer)rs.getObject("jpegsupport")) != null) {
            this.jpegSupport = intVal != 0;
        }
        if ((intVal = (Integer)rs.getObject("signedmidletsupport")) != null) {
            this.signedMidletSupport = intVal != 0;
        }
        if ((intVal = (Integer)rs.getObject("midletaccepttype")) != null) {
            this.midletAcceptType = MidletAcceptTypeEnum.fromValue(intVal);
        }
    ...
    public static enum MidletAcceptTypeEnum {
        ...
        public static MidletAcceptTypeEnum fromValue(int value) {
            for (MidletAcceptTypeEnum e : MidletAcceptTypeEnum.values()) {
