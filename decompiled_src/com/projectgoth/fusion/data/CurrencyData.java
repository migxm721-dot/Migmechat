...
implements Serializable {
    ...
    public CurrencyData(CurrencyDataIce currencyIce) {
        ...
        this.exchangeRate = currencyIce.exchangeRate == Double.MIN_VALUE ? null : Double.valueOf(currencyIce.exchangeRate);
    ...
    public String format(double amount) {
        ...
        return this.symbol + df.format(amount);
    }
    ...
    public String formatBaseCurrency(double amount) {
        ...
        return new DecimalFormat("0.00 ").format(amount) + baseCurrency + " (approx. " + this.format(this.convertFromBaseCurrency(amount)) + ")";
    }

    public String formatExchangeRate() {
        return "1 " + baseCurrency + " = Approx. " + this.format(this.convertFromBaseCurrency(1.0));
    }
}
