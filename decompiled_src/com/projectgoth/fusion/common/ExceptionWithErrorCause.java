...
public class ExceptionWithErrorCause
extends Exception {
    private ErrorCause errorCause;
    private Object[] errorMsgArgs;

    public ExceptionWithErrorCause(ErrorCause reasonType, Object ... errorMsgArgs) {
        super(ExceptionWithErrorCause.formatErrorMessage(reasonType.getDefaultErrorMessage(), errorMsgArgs));
    ...
    public ExceptionWithErrorCause(Throwable cause, ErrorCause reasonType, Object ... errorMsgArgs) {
        super(ExceptionWithErrorCause.formatErrorMessage(reasonType.getDefaultErrorMessage(), errorMsgArgs), cause);
        this.errorCause = reasonType;
        this.errorMsgArgs = errorMsgArgs;
    }
