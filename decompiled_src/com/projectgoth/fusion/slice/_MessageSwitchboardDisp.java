...
public abstract class _MessageSwitchboardDisp
extends ObjectImpl
implements MessageSwitchboard {
    ...
    public final GroupChatPrx ensureGroupChatExists(SessionPrx currentSession, String groupChatID) throws FusionException {
        return this.ensureGroupChatExists(currentSession, groupChatID, null);
    }
    ...
    public final void getAndPushMessages(String username, byte chatType, String suppliedChatID, long oldestMessageTimestamp, long newestMessageTimestamp, int limit, ConnectionPrx cxn) throws FusionException {
        this.getAndPushMessages(username, chatType, suppliedChatID, oldestMessageTimestamp, newestMessageTimestamp, limit, cxn, null);
    }
    ...
    public final void getAndPushMessages2(String username, byte chatType, String suppliedChatID, long oldestMessageTimestamp, long newestMessageTimestamp, int limit, ConnectionPrx cxn, int deviceType, short clientVersion, short fusionPktTransactionId) throws FusionException {
        this.getAndPushMessages2(username, chatType, suppliedChatID, oldestMessageTimestamp, newestMessageTimestamp, limit, cxn, deviceType, clientVersion, fusionPktTransactionId, null);
    }

    public final ChatDefinitionIce[] getChats(int userID, int chatListVersion, int limit, byte chatType) throws FusionException {
        return this.getChats(userID, chatListVersion, limit, chatType, null);
    }
    ...
    public final ChatDefinitionIce[] getChats2(int userID, int chatListVersion, int limit, byte chatType, ConnectionPrx cxn) throws FusionException {
        return this.getChats2(userID, chatListVersion, limit, chatType, cxn, null);
    }

    public final boolean isUserChatSyncEnabled(ConnectionPrx cxn, String username, int userID) throws FusionException {
        return this.isUserChatSyncEnabled(cxn, username, userID, null);
    }
    ...
    public final void onCreateGroupChat(ChatDefinitionIce storedGroupChat, String creatorUsername, String privateChatPartnerUsername, GroupChatPrx groupChatRemote) throws FusionException {
        this.onCreateGroupChat(storedGroupChat, creatorUsername, privateChatPartnerUsername, groupChatRemote, null);
    }
    ...
    public final void onCreatePrivateChat(int userID, String username, String otherUser, int deviceType, short clientVersion, UserDataIce senderUserData, String recipientDisplayPicture) throws FusionException {
        this.onCreatePrivateChat(userID, username, otherUser, deviceType, clientVersion, senderUserData, recipientDisplayPicture, null);
    }
    ...
    public final void onGetChats(ConnectionPrx cxn, int userID, int chatListVersion, int limit, byte chatType, short transactionId, String parentUsername) throws FusionException {
        this.onGetChats(cxn, userID, chatListVersion, limit, chatType, transactionId, parentUsername, null);
    }

    public final void onJoinChatRoom(String username, int userID, String chatRoomName) throws FusionException {
        this.onJoinChatRoom(username, userID, chatRoomName, null);
    }
    ...
    public final void onJoinGroupChat(String username, int userID, String groupChatGUID, boolean debug, UserPrx userProxy) throws FusionException {
        this.onJoinGroupChat(username, userID, groupChatGUID, debug, userProxy, null);
    }
    ...
    public final void onLeaveChatRoom(String username, int userID, String chatRoomName, UserPrx userProxy) throws FusionException {
        this.onLeaveChatRoom(username, userID, chatRoomName, userProxy, null);
    }
    ...
    public final void onLeaveGroupChat(String username, int userID, String groupChatGUID, UserPrx userProxy) throws FusionException {
        this.onLeaveGroupChat(username, userID, groupChatGUID, userProxy, null);
    }
    ...
    public final void onLeavePrivateChat(int userID, String username, String otherUser, int deviceType, short clientVersion) throws FusionException {
        this.onLeavePrivateChat(userID, username, otherUser, deviceType, clientVersion, null);
    }

    public final void onLogon(int userID, SessionPrx sess, short transactionID, String parentUsername) throws FusionException {
        this.onLogon(userID, sess, transactionID, parentUsername, null);
    }
    ...
    public final void onSendFusionMessageToChatRoom(SessionPrx currentSession, UserPrx parentUser, MessageDataIce messageData, String chatRoomName, int deviceType, short clientVersion) throws FusionException {
        this.onSendFusionMessageToChatRoom(currentSession, parentUser, messageData, chatRoomName, deviceType, clientVersion, null);
    }
    ...
    public final void onSendFusionMessageToGroupChat(SessionPrx currentSession, UserPrx parentUser, MessageDataIce messageData, String groupChatID, int deviceType, short clientVersion) throws FusionException {
        this.onSendFusionMessageToGroupChat(currentSession, parentUser, messageData, groupChatID, deviceType, clientVersion, null);
    }
    ...
    public final boolean onSendFusionMessageToIndividual(SessionPrx currentSession, UserPrx parentUser, MessageDataIce messageData, String destinationUsername, String[] uniqueUsersPrivateChattedWith, int deviceType, short clientVersion, UserDataIce senderUserData, String recipientDisplayPicture) throws FusionException {
        return this.onSendFusionMessageToIndividual(currentSession, parentUser, messageData, destinationUsername, uniqueUsersPrivateChattedWith, deviceType, clientVersion, senderUserData, recipientDisplayPicture, null);
    }
    ...
    public final boolean onSendMessageToAllUsersInChat(SessionPrx currentSession, UserPrx parentUser, MessageDataIce messageData, UserDataIce senderUserData) throws FusionException {
        return this.onSendMessageToAllUsersInChat(currentSession, parentUser, messageData, senderUserData, null);
    }
    ...
    public final void setChatName(String parentUsername, String suppliedChatID, byte chatType, String chatName, RegistryPrx regy) throws FusionException {
        this.setChatName(parentUsername, suppliedChatID, chatType, chatName, regy, null);
    }

    public static DispatchStatus ___isUserChatSyncEnabled(MessageSwitchboard __obj, Incoming __inS, Current __current) {
        _MessageSwitchboardDisp.__checkMode((OperationMode)OperationMode.Normal, (OperationMode)__current.mode);
    ...
    public DispatchStatus __dispatch(Incoming in, Current __current) {
        ...
        switch (pos) {
            case 0: {
                return _MessageSwitchboardDisp.___ensureGroupChatExists(this, in, __current);
            }
            case 1: {
                return _MessageSwitchboardDisp.___getAndPushMessages(this, in, __current);
            }
            case 2: {
                return _MessageSwitchboardDisp.___getAndPushMessages2(this, in, __current);
            }
            case 3: {
                return _MessageSwitchboardDisp.___getChats(this, in, __current);
            }
            case 4: {
                return _MessageSwitchboardDisp.___getChats2(this, in, __current);
            }
            case 5: {
                return _MessageSwitchboardDisp.___ice_id((Ice.Object)this, (Incoming)in, (Current)__current);
            }
            case 6: {
                return _MessageSwitchboardDisp.___ice_ids((Ice.Object)this, (Incoming)in, (Current)__current);
            }
            case 7: {
                return _MessageSwitchboardDisp.___ice_isA((Ice.Object)this, (Incoming)in, (Current)__current);
            }
            case 8: {
                return _MessageSwitchboardDisp.___ice_ping((Ice.Object)this, (Incoming)in, (Current)__current);
            }
            case 9: {
                return _MessageSwitchboardDisp.___isUserChatSyncEnabled(this, in, __current);
            }
            case 10: {
                return _MessageSwitchboardDisp.___onCreateGroupChat(this, in, __current);
            }
            case 11: {
                return _MessageSwitchboardDisp.___onCreatePrivateChat(this, in, __current);
            }
            case 12: {
                return _MessageSwitchboardDisp.___onGetChats(this, in, __current);
            }
            case 13: {
                return _MessageSwitchboardDisp.___onJoinChatRoom(this, in, __current);
            }
            case 14: {
                return _MessageSwitchboardDisp.___onJoinGroupChat(this, in, __current);
            }
            case 15: {
                return _MessageSwitchboardDisp.___onLeaveChatRoom(this, in, __current);
            }
            case 16: {
                return _MessageSwitchboardDisp.___onLeaveGroupChat(this, in, __current);
            }
            case 17: {
                return _MessageSwitchboardDisp.___onLeavePrivateChat(this, in, __current);
            }
            case 18: {
                return _MessageSwitchboardDisp.___onLogon(this, in, __current);
            }
            case 19: {
                return _MessageSwitchboardDisp.___onSendFusionMessageToChatRoom(this, in, __current);
            }
            case 20: {
                return _MessageSwitchboardDisp.___onSendFusionMessageToGroupChat(this, in, __current);
            }
            case 21: {
                return _MessageSwitchboardDisp.___onSendFusionMessageToIndividual(this, in, __current);
            }
            case 22: {
                return _MessageSwitchboardDisp.___onSendMessageToAllUsersInChat(this, in, __current);
            }
            case 23: {
                return _MessageSwitchboardDisp.___setChatName(this, in, __current);
            }
        }
        assert (false);
        throw new OperationNotExistException(__current.id, __current.facet, __current.operation);
    ...
    public void __write(BasicStream __os) {
        __os.writeTypeId(_MessageSwitchboardDisp.ice_staticId());
