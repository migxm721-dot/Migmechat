...
import com.projectgoth.fusion.slice.UserNotificationServiceStatsPrx;
import com.projectgoth.fusion.slice._UserNotificationServiceStatsDelD;
import com.projectgoth.fusion.slice._UserNotificationServiceStatsDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class UserNotificationServiceStatsPrxHelper
extends ObjectPrxHelperBase
implements UserNotificationServiceStatsPrx {
    public static UserNotificationServiceStatsPrx checkedCast(ObjectPrx __obj) {
        UserNotificationServiceStatsPrx __d;
        block3: {
            __d = null;
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::UserNotificationServiceStats")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::UserNotificationServiceStats", __ctx)) break block3;
                    UserNotificationServiceStatsPrxHelper __h = new UserNotificationServiceStatsPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static UserNotificationServiceStatsPrx checkedCast(ObjectPrx __obj, String __facet) {
        UserNotificationServiceStatsPrxHelper __d = null;
        if (__obj != null) {
