...
public abstract class _ConnectionWSDisp
extends ObjectImpl
implements ConnectionWS {
    ...
    public final void addRemoteChildConnectionWS(String uuid, ConnectionWSPrx childConnectionWS) {
        this.addRemoteChildConnectionWS(uuid, childConnectionWS, null);
    }

    public final void removeRemoteChildConnectionWS(String uuid, ConnectionWSPrx childConnectionWS) {
        this.removeRemoteChildConnectionWS(uuid, childConnectionWS, null);
    }

    public static DispatchStatus ___accessed(ConnectionWS __obj, Incoming __inS, Current __current) {
        _ConnectionWSDisp.__checkMode((OperationMode)OperationMode.Normal, (OperationMode)__current.mode);
    ...
    public DispatchStatus __dispatch(Incoming in, Current __current) {
        ...
        switch (pos) {
            case 0: {
                return _ConnectionWSDisp.___accessed(this, in, __current);
            }
            case 1: {
                return _ConnectionDisp.___accountBalanceChanged(this, in, __current);
            }
            case 2: {
                return _ConnectionWSDisp.___addRemoteChildConnectionWS(this, in, __current);
            }
            case 3: {
            ...
            case 26: {
                return _ConnectionWSDisp.___ice_id((Ice.Object)this, (Incoming)in, (Current)__current);
            }
            case 27: {
                return _ConnectionWSDisp.___ice_ids((Ice.Object)this, (Incoming)in, (Current)__current);
            }
            case 28: {
                return _ConnectionWSDisp.___ice_isA((Ice.Object)this, (Incoming)in, (Current)__current);
            }
            case 29: {
                return _ConnectionWSDisp.___ice_ping((Ice.Object)this, (Incoming)in, (Current)__current);
            }
            case 30: {
            ...
            case 54: {
                return _ConnectionWSDisp.___removeRemoteChildConnectionWS(this, in, __current);
            }
            case 55: {
    ...
    public void __write(BasicStream __os) {
        __os.writeTypeId(_ConnectionWSDisp.ice_staticId());
