...
import com.projectgoth.fusion.slice._GatewayAdminDelD;
import com.projectgoth.fusion.slice._GatewayAdminDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class GatewayAdminPrxHelper
extends ObjectPrxHelperBase
implements GatewayAdminPrx {
    @Override
    ...
    public void sendAlertToAllConnections(String message, String title) {
        this.sendAlertToAllConnections(message, title, null, false);
    }
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::GatewayAdmin")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::GatewayAdmin", __ctx)) break block3;
                    GatewayAdminPrxHelper __h = new GatewayAdminPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static GatewayAdminPrx checkedCast(ObjectPrx __obj, String __facet) {
        GatewayAdminPrxHelper __d = null;
        if (__obj != null) {
