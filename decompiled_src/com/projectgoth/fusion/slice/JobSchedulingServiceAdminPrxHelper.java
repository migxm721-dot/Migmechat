...
import com.projectgoth.fusion.slice._JobSchedulingServiceAdminDelD;
import com.projectgoth.fusion.slice._JobSchedulingServiceAdminDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class JobSchedulingServiceAdminPrxHelper
extends ObjectPrxHelperBase
implements JobSchedulingServiceAdminPrx {
    @Override
    ...
    public static JobSchedulingServiceAdminPrx checkedCast(ObjectPrx __obj) {
        JobSchedulingServiceAdminPrx __d;
        block3: {
            __d = null;
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::JobSchedulingServiceAdmin")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::JobSchedulingServiceAdmin", __ctx)) break block3;
                    JobSchedulingServiceAdminPrxHelper __h = new JobSchedulingServiceAdminPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static JobSchedulingServiceAdminPrx checkedCast(ObjectPrx __obj, String __facet) {
        JobSchedulingServiceAdminPrxHelper __d = null;
        if (__obj != null) {
