...
import com.projectgoth.fusion.slice._BotServiceAdminDelD;
import com.projectgoth.fusion.slice._BotServiceAdminDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class BotServiceAdminPrxHelper
extends ObjectPrxHelperBase
implements BotServiceAdminPrx {
    @Override
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::BotServiceAdmin")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::BotServiceAdmin", __ctx)) break block3;
                    BotServiceAdminPrxHelper __h = new BotServiceAdminPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static BotServiceAdminPrx checkedCast(ObjectPrx __obj, String __facet) {
        BotServiceAdminPrxHelper __d = null;
        if (__obj != null) {
