...
import com.projectgoth.fusion.slice._ObjectCacheOperations;

public class _ObjectCacheTie
...
implements TieBase {
    ...
    public boolean equals(Object rhs) {
        ...
        if (!(rhs instanceof _ObjectCacheTie)) {
            return false;
        }
        return this._ice_delegate.equals(((_ObjectCacheTie)rhs)._ice_delegate);
    }
