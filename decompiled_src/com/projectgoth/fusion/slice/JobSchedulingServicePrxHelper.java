...
import com.projectgoth.fusion.slice._JobSchedulingServiceDelD;
import com.projectgoth.fusion.slice._JobSchedulingServiceDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class JobSchedulingServicePrxHelper
extends ObjectPrxHelperBase
implements JobSchedulingServicePrx {
    @Override
    public void rescheduleFusionGroupEvent(GroupEvent event) throws FusionException {
        this.rescheduleFusionGroupEvent(event, null, false);
    }
    ...
    public int scheduleFusionGroupEvent(GroupEvent event) throws FusionException {
        return this.scheduleFusionGroupEvent(event, null, false);
    }
    ...
    public String scheduleFusionGroupEventNotificationViaAlert(int eventId, int groupId, long time, String message) throws FusionException {
        return this.scheduleFusionGroupEventNotificationViaAlert(eventId, groupId, time, message, null, false);
    }
    ...
    public String scheduleFusionGroupEventNotificationViaEmail(int eventId, int groupId, long time, EmailUserNotification note) throws FusionException {
        return this.scheduleFusionGroupEventNotificationViaEmail(eventId, groupId, time, note, null, false);
    }
    ...
    public String scheduleFusionGroupEventNotificationViaSMS(int eventId, int groupId, long time, SMSUserNotification note) throws FusionException {
        return this.scheduleFusionGroupEventNotificationViaSMS(eventId, groupId, time, note, null, false);
    }
    ...
    public void triggerJob(String jobName, String jobGroup, Map<String, String> jobDataMap) throws FusionException {
        this.triggerJob(jobName, jobGroup, jobDataMap, null, false);
    }
    ...
    public void unscheduleFusionGroupEvent(int groupEventID) throws FusionException {
        this.unscheduleFusionGroupEvent(groupEventID, null, false);
    }
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::JobSchedulingService")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::JobSchedulingService", __ctx)) break block3;
                    JobSchedulingServicePrxHelper __h = new JobSchedulingServicePrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static JobSchedulingServicePrx checkedCast(ObjectPrx __obj, String __facet) {
        JobSchedulingServicePrxHelper __d = null;
        if (__obj != null) {
