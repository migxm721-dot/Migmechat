 ...
 */
public final class _ReputationServiceAdminDelD
extends _ObjectDelD
implements _ReputationServiceAdminDel {
    ...
    public ReputationServiceStats getStats(Map<String, String> __ctx) throws LocalExceptionWrapper, FusionException {
        ...
        final ReputationServiceStatsHolder __result = new ReputationServiceStatsHolder();
        ...
        try {
            ...
            __direct = new Direct(__current){
                ...
                public DispatchStatus run(Object __obj) {
                    ReputationServiceAdmin __servant = null;
                    try {
                        __servant = (ReputationServiceAdmin)__obj;
                    }
            ...
            try {
                ...
                reputationServiceStats = __result.value;
