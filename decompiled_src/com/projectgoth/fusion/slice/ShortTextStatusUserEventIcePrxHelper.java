...
import com.projectgoth.fusion.slice.ShortTextStatusUserEventIcePrx;
import com.projectgoth.fusion.slice._ShortTextStatusUserEventIceDelD;
import com.projectgoth.fusion.slice._ShortTextStatusUserEventIceDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class ShortTextStatusUserEventIcePrxHelper
extends ObjectPrxHelperBase
implements ShortTextStatusUserEventIcePrx {
    public static ShortTextStatusUserEventIcePrx checkedCast(ObjectPrx __obj) {
        ShortTextStatusUserEventIcePrx __d;
        block3: {
            __d = null;
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::ShortTextStatusUserEventIce")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::ShortTextStatusUserEventIce", __ctx)) break block3;
                    ShortTextStatusUserEventIcePrxHelper __h = new ShortTextStatusUserEventIcePrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static ShortTextStatusUserEventIcePrx checkedCast(ObjectPrx __obj, String __facet) {
        ShortTextStatusUserEventIcePrxHelper __d = null;
        if (__obj != null) {
