...
import com.projectgoth.fusion.slice._RegistryAdminDelD;
import com.projectgoth.fusion.slice._RegistryAdminDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class RegistryAdminPrxHelper
extends ObjectPrxHelperBase
implements RegistryAdminPrx {
    @Override
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::RegistryAdmin")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::RegistryAdmin", __ctx)) break block3;
                    RegistryAdminPrxHelper __h = new RegistryAdminPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static RegistryAdminPrx checkedCast(ObjectPrx __obj, String __facet) {
        RegistryAdminPrxHelper __d = null;
        if (__obj != null) {
