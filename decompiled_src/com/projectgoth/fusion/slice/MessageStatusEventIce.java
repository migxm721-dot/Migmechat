...
public final class MessageStatusEventIce
...
Serializable {
    ...
    public boolean equals(Object rhs) {
        ...
        if (_r != null) {
            ...
            if (this.messageSource != _r.messageSource && this.messageSource != null && !this.messageSource.equals(_r.messageSource)) {
                return false;
            }
            if (this.messageDestinationType != _r.messageDestinationType) {
                return false;
            }
            if (this.messageDestination != _r.messageDestination && this.messageDestination != null && !this.messageDestination.equals(_r.messageDestination)) {
                return false;
            }
            if (this.messageGUID != _r.messageGUID && this.messageGUID != null && !this.messageGUID.equals(_r.messageGUID)) {
                return false;
            }
            if (this.messageStatus != _r.messageStatus) {
                return false;
            }
            if (this.serverGenerated != _r.serverGenerated) {
                return false;
            }
