...
import com.projectgoth.fusion.slice._SessionCacheAdminOperations;

public class _SessionCacheAdminTie
...
implements TieBase {
    ...
    public boolean equals(Object rhs) {
        ...
        if (!(rhs instanceof _SessionCacheAdminTie)) {
            return false;
        }
        return this._ice_delegate.equals(((_SessionCacheAdminTie)rhs)._ice_delegate);
    }
