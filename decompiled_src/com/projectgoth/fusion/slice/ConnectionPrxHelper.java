...
import com.projectgoth.fusion.slice._ConnectionDelD;
import com.projectgoth.fusion.slice._ConnectionDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class ConnectionPrxHelper
extends ObjectPrxHelperBase
implements ConnectionPrx {
    @Override
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::Connection")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::Connection", __ctx)) break block3;
                    ConnectionPrxHelper __h = new ConnectionPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
