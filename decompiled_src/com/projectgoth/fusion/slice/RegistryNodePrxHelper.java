...
import com.projectgoth.fusion.slice._RegistryNodeDelD;
import com.projectgoth.fusion.slice._RegistryNodeDelM;
import java.util.Map;

/*
 * This class specifies class file version 49.0 but uses Java 6 signatures.  Assumed Java 6.
 */
public final class RegistryNodePrxHelper
extends ObjectPrxHelperBase
implements RegistryNodePrx {
    @Override
    ...
    public void registerMessageSwitchboard(String hostName, MessageSwitchboardPrx cacheProxy, MessageSwitchboardAdminPrx adminProxy) {
        this.registerMessageSwitchboard(hostName, cacheProxy, adminProxy, null, false);
    }
    ...
    public String registerNewNode(RegistryNodePrx newNodeProxy, String hostName, boolean replicate) throws FusionException {
        return this.registerNewNode(newNodeProxy, hostName, replicate, null, false);
    }
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::RegistryNode")) break block3;
        ...
        block3: {
            ...
            if (__obj != null) {
                try {
                    ...
                    if (!__obj.ice_isA("::com::projectgoth::fusion::slice::RegistryNode", __ctx)) break block3;
                    RegistryNodePrxHelper __h = new RegistryNodePrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
                }
    ...
    public static RegistryNodePrx checkedCast(ObjectPrx __obj, String __facet) {
        RegistryNodePrxHelper __d = null;
        if (__obj != null) {
