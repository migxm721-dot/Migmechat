...
public class DailyPeriodBoundaryTask
extends TimerTask {
    private Logger log = Logger.getLogger((String)ConfigUtils.getLoggerName(DailyPeriodBoundaryTask.class));
    ...
    public void run() {
        ...
        this.log.info((Object)("setting end of observation period " + newDate));
