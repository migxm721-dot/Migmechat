...
public class AccountEntryMetrics
implements Metrics {
    ...
    public boolean hasMetrics() {
        return this.authenticatedReferrals != 0 || this.kicksInitiated != 0 || this.rechargedAmount != 0.0;
    }

    public String toLine() {
        StringBuilder builder = new StringBuilder();
        builder.append(this.username).append(',').append(this.kicksInitiated).append(',').append(this.authenticatedReferrals).append(',').append((long)(this.rechargedAmount * 100.0));
