...
public class MatchScorecard {
    ...
    public boolean isSixer() {
        return !StringUtils.isEmpty((String)this.ballDetail.trim()) && this.ballDetail.equalsIgnoreCase("Sixer");
    }

    public boolean isFour() {
        return !StringUtils.isEmpty((String)this.ballDetail.trim()) && this.ballDetail.equalsIgnoreCase("Boundary");
    }

    public boolean isOut() {
        return !StringUtils.isEmpty((String)this.ballDetail.trim()) && (this.ballDetail.startsWith("c ") || this.ballDetail.startsWith("b ") || this.ballDetail.startsWith("run out "));
    }
}
